...
float l9_2=max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*Port_Normal_N041)),Tweak_N44),0.0)*fadeLevel;
int l9_3;
...
#endif
vec4 l9_28=Port_Value_N017+l9_27;
vec4 l9_29=l9_28*l9_27;
vec4 l9_30=vec4(l9_2);
vec3 l9_31=l9_30.xyz*l9_2;
int l9_32;
...
#endif
bool l9_33=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_34=varTex01.z;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_35=l9_34;
float l9_36=varTex01.w;
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_37=l9_36;
vec2 l9_38;
float l9_39;
...
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
...
float l9_41=l9_35;
float l9_42=1.0;
sc_ClampUV(l9_41,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_40,l9_42);
float l9_43=l9_41;
float l9_44=l9_42;
bool l9_45;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_45=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_46=l9_37;
float l9_47=l9_44;
sc_ClampUV(l9_46,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_45,l9_47);
l9_39=l9_47;
...
#endif
vec2 l9_48=sc_TransformUV(l9_38,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_49=l9_48.x;
float l9_50=l9_39;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_33,l9_50);
float l9_51=l9_48.y;
float l9_52=l9_50;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_33,l9_52);
float l9_53=l9_52;
vec3 l9_54=sc_SamplingCoordsViewToGlobal(vec2(l9_49,l9_51),Tweak_N0Layout,l9_32);
vec4 l9_55=texture2D(Tweak_N0,l9_54.xy,0.0);
vec4 l9_56;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_56=mix(Tweak_N0BorderColor,l9_55,vec4(l9_53));
}
#else
{
l9_56=l9_55;
...
#endif
vec4 l9_57=l9_56*vec4(opacityIntensity);
float l9_58=l9_57.x;
vec4 l9_59=vec4(min(vec4(l9_31.x,l9_31.y,l9_31.z,l9_30.w)+((l9_29*Port_Value_N017)*vec4(glowIntensity)),vec4(1.0)).xyz,l9_58);
...
{
l9_63=clamp(dot(l9_59.xyz,vec3(l9_58)),0.0,1.0);
}
#else
{
float l9_64;
...
{
l9_65=(1.0-dot(l9_59.xyz,vec3(0.33333001)))*l9_58;
}
#else
{
float l9_66;
...
{
l9_66=(1.0-clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0))*l9_58;
}
#else
{
float l9_67;
...
{
l9_67=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0)*l9_58;
}
#else
{
float l9_68;
#if (sc_BlendMode_Add)
{
l9_68=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_69;
...
{
l9_70=dot(l9_59.xyz,vec3(0.33333001))*l9_58;
}
#else
{
float l9_71;
#if (sc_BlendMode_Min)
{
l9_71=1.0-clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_72;
#if (sc_BlendMode_Max)
{
l9_72=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_72=1.0;
...
#endif
l9_60=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_59.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_61);
}
#else
{
vec4 l9_73;
...
#endif
vec3 l9_78=mix(l9_75.xyz,definedBlend(l9_75.xyz,l9_59.xyz).xyz,vec3(l9_58));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_83=vec4(mix(vec3(1.0),l9_59.xyz,vec3(l9_58)),l9_58);
}
#else
{
vec4 l9_84;
...
#endif
l9_84=vec4(l9_59.xyz*l9_85,l9_85);
}
#else
{
l9_84=l9_59;
