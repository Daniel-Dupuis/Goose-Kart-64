...
#endif
sc_writeFragData0Internal(max(l9_121,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_123;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_153-0.0039215689)),min(1.0,l9_153+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_155),packValue(l9_155),packValue(l9_155),packValue(l9_155)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_156,packValue(l9_155),packValue(l9_155),packValue(l9_155)));
sc_writeFragData2(vec4(l9_164,packValue(l9_163),packValue(l9_163),packValue(l9_163)));
