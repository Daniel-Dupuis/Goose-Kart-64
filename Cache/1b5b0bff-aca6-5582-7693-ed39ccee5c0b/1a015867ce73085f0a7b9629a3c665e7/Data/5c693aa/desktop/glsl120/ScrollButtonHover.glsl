...
vec3 l9_94=-normalize(sc_Camera.position-varPosAndMotion.xyz);
...
float l9_96=clamp(length((varTex01.xy*Port_Input1_N067)+Port_Input2_N067),0.0,1.0);
vec4 l9_97;
...
vec4 l9_106=l9_100+mix(mix(Port_Input0_N092,Port_Input1_N092,vec4(max(pow(1.0-abs(dot(l9_94,l9_2*Port_Normal_N091)),Port_Exponent_N091),0.0)*Port_Intensity_N091)),Port_Input1_N093,mix(Port_Import_N074,Port_Import_N075,vec4(smoothstep(Port_Input0_N087,Port_Input1_N087,clamp((dot((((((((varTex01.xy-vec2(Port_RangeMinA_N076))/vec2((Port_RangeMaxA_N076-Port_RangeMinA_N076)+1e-06))*(Port_RangeMaxB_N076-Port_RangeMinB_N076))+vec2(Port_RangeMinB_N076))-Port_Center_N078)*(vec2(dot(vec2(l9_103,l9_102),l9_104),dot(vec2(-l9_102,l9_103),l9_104))+Port_Center_N090))+Port_Center_N078)-Port_Import_N079,l9_105)/dot(l9_105,l9_105))+0.001,Port_Input1_N086+0.001,Port_Input2_N086+0.001)-0.001))));
float l9_107=clamp(length((varTex01.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
float l9_108;
...
#if (sc_FramebufferFetch)
{
l9_129=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_129=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_130,sc_ScreenTextureLayout,l9_131).xy,0.0);
}
#endif
vec3 l9_132=mix(l9_129.xyz,definedBlend(l9_129.xyz,l9_112.xyz).xyz,vec3(l9_113));
...
#if (sc_Voxelization)
{
l9_134=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_135;
#if (sc_OutputBounds)
{
float l9_136=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_135=vec4(l9_136,1.0-l9_136,1.0,1.0);
}
#else
{
vec4 l9_137;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_137=vec4(mix(vec3(1.0),l9_112.xyz,vec3(l9_113)),l9_113);
}
#else
{
vec4 l9_138;
...
#endif
l9_138=vec4(l9_112.xyz*l9_139,l9_139);
}
#else
{
l9_138=l9_112;
...
vec4 l9_142=sc_OutputMotionVectorIfNeeded(max(l9_140,vec4(0.0)));
vec4 l9_143=clamp(l9_142,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_144=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_144-0.0039215689)),min(1.0,l9_144+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_145).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_146=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_145).xy);
float l9_147=packValue(l9_146);
int l9_154=int(l9_143.w*255.0);
float l9_155=packValue(l9_154);
sc_writeFragData0Internal(vec4(packValue(l9_146),packValue(l9_146),packValue(l9_146),packValue(l9_146)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_147,packValue(l9_146),packValue(l9_146),packValue(l9_146)));
sc_writeFragData2(vec4(l9_155,packValue(l9_154),packValue(l9_154),packValue(l9_154)));
...
if (l9_163==0)
{
l9_166=texture2D(sc_OITAlpha0,l9_158);
l9_165=texture2D(sc_OITDepthLow0,l9_158);
l9_164=texture2D(sc_OITDepthHigh0,l9_158);
}
else
{
l9_166=vec4(0.0);
...
if (l9_163==1)
{
l9_169=texture2D(sc_OITAlpha1,l9_158);
l9_168=texture2D(sc_OITDepthLow1,l9_158);
l9_167=texture2D(sc_OITDepthHigh1,l9_158);
}
else
{
l9_169=l9_166;
...
if (any(notEqual(l9_167,vec4(0.0)))||any(notEqual(l9_168,vec4(0.0))))
{
int l9_170[8]=l9_159;
unpackValues(l9_167.w,l9_163,l9_170);
unpackValues(l9_167.z,l9_163,l9_170);
unpackValues(l9_167.y,l9_163,l9_170);
unpackValues(l9_167.x,l9_163,l9_170);
unpackValues(l9_168.w,l9_163,l9_170);
unpackValues(l9_168.z,l9_163,l9_170);
unpackValues(l9_168.y,l9_163,l9_170);
unpackValues(l9_168.x,l9_163,l9_170);
int l9_179[8]=l9_160;
unpackValues(l9_169.w,l9_163,l9_179);
unpackValues(l9_169.z,l9_163,l9_179);
unpackValues(l9_169.y,l9_163,l9_179);
unpackValues(l9_169.x,l9_163,l9_179);
}
l9_163++;
continue;
}
...
vec4 l9_184=texture2D(sc_OITFilteredDepthBoundsTexture,l9_158);
vec2 l9_185=l9_184.xy;
int l9_186;
#if (sc_SkinBonesCount>0)
{
l9_186=encodeDepth(((1.0-l9_184.x)*1000.0)+getDepthOrderingEpsilon(),l9_185);
}
#else
{
l9_186=0;
...
#endif
int l9_187=encodeDepth(viewSpaceDepth(),l9_185);
vec4 l9_188;
l9_188=l9_143*l9_143.w;
vec4 l9_189;
int l9_190=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_190<8)
{
int l9_191=l9_159[l9_190];
int l9_192=l9_187-l9_186;
bool l9_193=l9_191<l9_192;
bool l9_194;
if (l9_193)
{
l9_194=l9_159[l9_190]>0;
}
else
{
l9_194=l9_193;
...
if (l9_194)
{
vec3 l9_195=l9_188.xyz*(1.0-(float(l9_160[l9_190])/255.0));
l9_189=vec4(l9_195.x,l9_195.y,l9_195.z,l9_188.w);
}
else
{
l9_189=l9_188;
...
sc_writeFragData0Internal(l9_188,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
