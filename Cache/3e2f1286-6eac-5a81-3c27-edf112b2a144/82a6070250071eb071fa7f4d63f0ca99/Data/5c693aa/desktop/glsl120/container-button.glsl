...
vec4 l9_1=vec4(normalize(varNormalAndMotion.xyz),0.0);
vec3 l9_2=cross(normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0)).xyz),normalize((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1).xyz));
vec2 l9_3=l9_2.yx;
l9_3.x=l9_2.y*(-1.0);
...
vec2 l9_47=((varTex01.xy-Port_Center_N002)*iconScale)+Port_Center_N002;
int l9_48;
...
#endif
vec3 l9_95=mix(l9_92.xyz,definedBlend(l9_92.xyz,l9_76.xyz).xyz,vec3(l9_75));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_100=vec4(mix(vec3(1.0),l9_76.xyz,vec3(l9_75)),l9_75);
}
#else
{
vec4 l9_101;
...
#endif
l9_101=vec4(l9_76.xyz*l9_102,l9_102);
}
#else
{
l9_101=l9_76;
...
vec4 l9_105=sc_OutputMotionVectorIfNeeded(max(l9_103,vec4(0.0)));
