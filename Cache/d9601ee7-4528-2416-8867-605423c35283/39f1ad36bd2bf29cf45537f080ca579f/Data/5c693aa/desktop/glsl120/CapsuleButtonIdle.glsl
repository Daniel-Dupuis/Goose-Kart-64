...
float l9_91=clamp(l9_90.x,0.0,1.0);
vec4 l9_92;
if (l9_91<Port_Position1_N007)
{
l9_92=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_91/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_93;
if (l9_91<Port_Position2_N007)
{
l9_93=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_91-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_94;
if (l9_91<Port_Position3_N007)
{
l9_94=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_91-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_94=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_91-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_93=l9_94;
}
l9_92=l9_93;
}
float l9_95=clamp(length((varTex01.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_96;
if (l9_95<Port_Position1_N031)
{
l9_96=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_95/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_97;
if (l9_95<Port_Position2_N031)
{
l9_97=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_95-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_98;
if (l9_95<Port_Position3_N031)
{
l9_98=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_95-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_98=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_95-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_97=l9_98;
}
l9_96=l9_97;
}
vec4 l9_99=mix(l9_92,l9_96,l9_96);
float l9_100=clamp(l9_92.x,0.0,1.0);
float l9_101;
if (l9_100<Port_Position1_N011)
{
l9_101=mix(Port_Value0_N011,Port_Value1_N011,clamp(l9_100/Port_Position1_N011,0.0,1.0));
}
else
{
float l9_102;
if (l9_100<Port_Position2_N011)
{
l9_102=mix(Port_Value1_N011,Port_Value2_N011,clamp((l9_100-Port_Position1_N011)/(Port_Position2_N011-Port_Position1_N011),0.0,1.0));
}
else
{
float l9_103;
if (l9_100<Port_Position3_N011)
{
l9_103=mix(Port_Value2_N011,Port_Value3_N011,clamp((l9_100-Port_Position2_N011)/(Port_Position3_N011-Port_Position2_N011),0.0,1.0));
}
else
{
l9_103=mix(Port_Value3_N011,Port_Value4_N011,clamp((l9_100-Port_Position3_N011)/(1.0-Port_Position3_N011),0.0,1.0));
}
l9_102=l9_103;
}
l9_101=l9_102;
}
vec4 l9_104=vec4(l9_99.x,l9_99.y,l9_99.z,vec4(0.0).w);
l9_104.w=l9_101;
vec4 l9_105=l9_59+l9_104;
float l9_106=l9_105.w;
...
{
l9_109=clamp(l9_106*2.0,0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_110=clamp(dot(l9_105.xyz,vec3(l9_106)),0.0,1.0);
}
#else
{
float l9_111;
...
{
l9_112=(1.0-dot(l9_105.xyz,vec3(0.33333001)))*l9_106;
}
#else
{
float l9_113;
...
{
l9_113=(1.0-clamp(dot(l9_105.xyz,vec3(1.0)),0.0,1.0))*l9_106;
}
#else
{
float l9_114;
...
{
l9_114=clamp(dot(l9_105.xyz,vec3(1.0)),0.0,1.0)*l9_106;
}
#else
{
float l9_115;
#if (sc_BlendMode_Add)
{
l9_115=clamp(dot(l9_105.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_116;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_116=clamp(dot(l9_105.xyz,vec3(1.0)),0.0,1.0)*l9_106;
}
#else
{
float l9_117;
...
{
l9_117=dot(l9_105.xyz,vec3(0.33333001))*l9_106;
}
#else
{
float l9_118;
#if (sc_BlendMode_Min)
{
l9_118=1.0-clamp(dot(l9_105.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_119;
#if (sc_BlendMode_Max)
{
l9_119=clamp(dot(l9_105.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_119=1.0;
...
#endif
l9_107=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_105.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_108);
}
#else
{
vec4 l9_120;
...
#endif
l9_122=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_123,sc_ScreenTextureLayout,l9_124).xy,0.0);
}
#endif
vec3 l9_125=mix(l9_122.xyz,definedBlend(l9_122.xyz,l9_105.xyz).xyz,vec3(l9_106));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_130=vec4(mix(vec3(1.0),l9_105.xyz,vec3(l9_106)),l9_106);
}
#else
{
vec4 l9_131;
...
#endif
l9_131=vec4(l9_105.xyz*l9_132,l9_132);
}
#else
{
l9_131=l9_105;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_137-0.0039215689)),min(1.0,l9_137+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_139),packValue(l9_139),packValue(l9_139),packValue(l9_139)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_181,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
