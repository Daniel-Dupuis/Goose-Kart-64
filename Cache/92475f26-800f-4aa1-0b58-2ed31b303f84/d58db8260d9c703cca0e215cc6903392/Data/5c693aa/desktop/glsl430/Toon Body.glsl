...
//sampler sampler opacityTextureSmpSC 0:24
...
//texture texture2D opacityTexture 0:5:0:24
...
//texture texture2DArray opacityTextureArrSC 0:36:0:24
...
//spec_const bool Tweak_N12 40 0
//spec_const bool Tweak_N27 41 0
...
//spec_const int opacityTextureLayout 90 0
//spec_const int sc_DepthBufferMode 91 0
//spec_const int sc_DirectionalLightsCount 92 0
...
uniform float Port_Input2_N113;
uniform int PreviewEnabled;
...
{
vec3 l9_60;
if ((float(lineWeight<clamp(dot(l9_2,l9_1),0.0,1.0))*1.0)!=0.0)
{
bool l9_61=l9_59<sc_DirectionalLightsCount;
vec3 l9_62;
if (l9_61)
{
l9_62=sc_DirectionalLights[l9_59].color.xyz;
}
else
{
l9_62=vec3(0.0);
...
if (l9_61)
{
l9_63=sc_DirectionalLights[l9_59].color.w;
}
else
{
l9_63=0.0;
...
vec3 l9_65;
if ((float(Port_Input0_N015<dot(l9_1,l9_64))*1.0)!=0.0)
{
l9_65=baseColor.xyz;
}
else
{
l9_65=baseColor.xyz*vec3(1.0-shadowIntensity);
}
l9_60=(l9_62*vec3(l9_63))*l9_65;
}
else
{
l9_60=lineColor.xyz;
...
l9_55=l9_57/vec3(float(sc_DirectionalLightsCount));
}
#else
{
l9_55=vec3(0.0);
...
{
bool l9_69=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_70=l9_3.x;
sc_SoftwareWrapEarly(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_71=l9_70;
float l9_72=l9_3.y;
sc_SoftwareWrapEarly(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_73=l9_72;
vec2 l9_74;
float l9_75;
...
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_77=l9_71;
float l9_78=1.0;
sc_ClampUV(l9_77,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_76,l9_78);
float l9_79=l9_77;
float l9_80=l9_78;
bool l9_81;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_82=l9_73;
float l9_83=l9_80;
sc_ClampUV(l9_82,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_81,l9_83);
l9_75=l9_83;
...
#endif
vec2 l9_84=sc_TransformUV(l9_74,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_85=l9_84.x;
float l9_86=l9_75;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_69,l9_86);
float l9_87=l9_84.y;
float l9_88=l9_86;
sc_SoftwareWrapLate(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_69,l9_88);
float l9_89=l9_88;
vec3 l9_90=sc_SamplingCoordsViewToGlobal(vec2(l9_85,l9_87),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_91=texture(opacityTextureArrSC,l9_90,0.0);
vec4 l9_92;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_92=mix(opacityTextureBorderColor,l9_91,vec4(l9_89));
}
#else
{
l9_92=l9_91;
...
#else
{
bool l9_93=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_94=l9_3.x;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_95=l9_94;
float l9_96=l9_3.y;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_97=l9_96;
vec2 l9_98;
float l9_99;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_101=l9_95;
float l9_102=1.0;
sc_ClampUV(l9_101,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_100,l9_102);
float l9_103=l9_101;
float l9_104=l9_102;
bool l9_105;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_106=l9_97;
float l9_107=l9_104;
sc_ClampUV(l9_106,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_105,l9_107);
l9_99=l9_107;
...
#endif
vec2 l9_108=sc_TransformUV(l9_98,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_109=l9_108.x;
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_93,l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_93,l9_112);
float l9_113=l9_112;
vec3 l9_114=sc_SamplingCoordsViewToGlobal(vec2(l9_109,l9_111),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_115=texture(opacityTexture,l9_114.xy,0.0);
vec4 l9_116;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_116=mix(opacityTextureBorderColor,l9_115,vec4(l9_113));
}
#else
{
l9_116=l9_115;
...
#else
{
l9_67=vec4(Port_Input2_N110);
}
#endif
float l9_117=clamp((baseColor.w*l9_67.x)+0.001,Port_Input1_N113+0.001,Port_Input2_N113+0.001)-0.001;
vec4 l9_118=vec4(l9_66.x,l9_66.y,l9_66.z,vec4(0.0).w);
l9_118.w=l9_117;
...
#endif
sc_writeFragData0Internal(max(l9_119,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_121;
...
{
l9_123=clamp(l9_117*2.0,0.0,1.0);
}
#else
{
float l9_124;
...
{
l9_124=clamp(dot(l9_118.xyz,vec3(l9_117)),0.0,1.0);
}
#else
{
float l9_125;
...
{
l9_126=(1.0-dot(l9_118.xyz,vec3(0.33333001)))*l9_117;
}
#else
{
float l9_127;
...
{
l9_127=(1.0-clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0))*l9_117;
}
#else
{
float l9_128;
...
#if (sc_BlendMode_Add)
{
l9_129=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_130;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_130=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0)*l9_117;
}
#else
{
float l9_131;
...
{
l9_131=dot(l9_118.xyz,vec3(0.33333001))*l9_117;
}
#else
{
float l9_132;
#if (sc_BlendMode_Min)
{
l9_132=1.0-clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_133;
#if (sc_BlendMode_Max)
{
l9_133=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_133=1.0;
...
#endif
l9_121=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_118.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_122);
}
#else
{
vec4 l9_134;
...
#endif
vec3 l9_139=mix(l9_136.xyz,definedBlend(l9_136.xyz,l9_118.xyz).xyz,vec3(l9_117));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_144=vec4(mix(vec3(1.0),l9_118.xyz,vec3(l9_117)),l9_117);
}
#else
{
vec4 l9_145;
...
#endif
l9_145=vec4(l9_118.xyz*l9_146,l9_146);
}
#else
{
l9_145=l9_118;
...
vec4 l9_149=sc_OutputMotionVectorIfNeeded(max(l9_147,vec4(0.0)));
