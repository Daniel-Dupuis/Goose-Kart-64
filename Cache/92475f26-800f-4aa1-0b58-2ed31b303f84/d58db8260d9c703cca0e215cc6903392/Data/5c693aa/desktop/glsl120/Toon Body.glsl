...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTexture 83 -1
...
{
vec3 l9_32;
if ((float(lineWeight<clamp(dot(normalize(sc_Camera.position-varPosAndMotion.xyz),l9_0),0.0,1.0))*1.0)!=0.0)
{
bool l9_33=l9_31<sc_DirectionalLightsCount;
vec3 l9_34;
if (l9_33)
{
l9_34=sc_DirectionalLights[l9_31].color.xyz;
}
else
{
l9_34=vec3(0.0);
...
if (l9_33)
{
l9_35=sc_DirectionalLights[l9_31].color.w;
}
else
{
l9_35=0.0;
...
if (l9_33)
{
l9_36=-sc_DirectionalLights[l9_31].direction;
}
else
{
l9_36=vec3(0.0);
...
vec3 l9_37;
if ((float(Port_Input0_N015<dot(l9_0,l9_36))*1.0)!=0.0)
{
l9_37=baseColor.xyz;
}
else
{
l9_37=baseColor.xyz*vec3(1.0-shadowIntensity);
}
l9_32=(l9_34*vec3(l9_35))*l9_37;
}
else
{
l9_32=lineColor.xyz;
...
l9_27=l9_29/vec3(float(sc_DirectionalLightsCount));
}
#else
{
l9_27=vec3(0.0);
...
#endif
bool l9_41=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_42=varTex01.x;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_43=l9_42;
float l9_44=varTex01.y;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_45=l9_44;
vec2 l9_46;
float l9_47;
...
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_48=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_49=l9_43;
float l9_50=1.0;
sc_ClampUV(l9_49,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_48,l9_50);
float l9_51=l9_49;
float l9_52=l9_50;
bool l9_53;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_53=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_53=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_54=l9_45;
float l9_55=l9_52;
sc_ClampUV(l9_54,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_53,l9_55);
l9_47=l9_55;
...
#endif
vec2 l9_56=sc_TransformUV(l9_46,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_57=l9_56.x;
float l9_58=l9_47;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_41,l9_58);
float l9_59=l9_56.y;
float l9_60=l9_58;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_41,l9_60);
float l9_61=l9_60;
vec3 l9_62=sc_SamplingCoordsViewToGlobal(vec2(l9_57,l9_59),opacityTextureLayout,l9_40);
vec4 l9_63=texture2D(opacityTexture,l9_62.xy,0.0);
vec4 l9_64;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_64=mix(opacityTextureBorderColor,l9_63,vec4(l9_61));
}
#else
{
l9_64=l9_63;
...
#else
{
l9_39=vec4(Port_Input2_N110);
}
#endif
float l9_65=clamp((baseColor.w*l9_39.x)+0.001,Port_Input1_N113+0.001,Port_Input2_N113+0.001)-0.001;
vec4 l9_66=vec4(l9_38.x,l9_38.y,l9_38.z,vec4(0.0).w);
l9_66.w=l9_65;
...
#if (sc_FramebufferFetch)
{
l9_82=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_82=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_83,sc_ScreenTextureLayout,l9_84).xy,0.0);
}
#endif
vec3 l9_85=mix(l9_82.xyz,definedBlend(l9_82.xyz,l9_66.xyz).xyz,vec3(l9_65));
...
#if (sc_Voxelization)
{
l9_87=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_88;
#if (sc_OutputBounds)
{
float l9_89=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_88=vec4(l9_89,1.0-l9_89,1.0,1.0);
}
#else
{
vec4 l9_90;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_90=vec4(mix(vec3(1.0),l9_66.xyz,vec3(l9_65)),l9_65);
}
#else
{
vec4 l9_91;
...
#endif
l9_91=vec4(l9_66.xyz*l9_92,l9_92);
}
#else
{
l9_91=l9_66;
...
vec4 l9_95=sc_OutputMotionVectorIfNeeded(max(l9_93,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_97-0.0039215689)),min(1.0,l9_97+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_99),packValue(l9_99),packValue(l9_99),packValue(l9_99)),sc_UniformConstants.x,sc_ShaderCacheConstant);
