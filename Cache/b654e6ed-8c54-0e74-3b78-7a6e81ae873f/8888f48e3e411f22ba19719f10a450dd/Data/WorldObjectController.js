...
function onSurfaceReset(eventData) {
    print("Reset - Original position: " + originalPosition);
    script.getSceneObject().getTransform().setLocalPosition(originalPosition);
    print("Reset - Position after reset: " + script.getSceneObject().getTransform().getLocalPosition());
    
    // Make sure the object is enabled/visible
