...
#endif
bool l9_2=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskMap)!=0));
float l9_3=varTex01.z;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x);
float l9_4=l9_3;
float l9_5=varTex01.w;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,maskMapUvMinMax.x,maskMapUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,maskMapUvMinMax.y,maskMapUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_maskMap)!=0),maskMapTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x,l9_2,l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y,l9_2,l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),maskMapLayout,l9_1);
vec4 l9_24=texture2D(maskMap,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_25=mix(maskMapBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#endif
float l9_26=radians(Port_Rotation_N018);
float l9_27=clamp((vec2(dot(vec2(cos(l9_26),sin(l9_26)),varTex01.xy-Port_Center_N018),0.0)+Port_Center_N018).x,0.0,1.0);
float l9_28;
if (l9_27<Port_Position1_N020)
{
l9_28=mix(Port_Value0_N020,Port_Value1_N020,clamp(l9_27/Port_Position1_N020,0.0,1.0));
}
else
{
float l9_29;
if (l9_27<pokeOccludeGradientMaskPosition)
{
l9_29=mix(Port_Value1_N020,Port_Value2_N020,clamp((l9_27-Port_Position1_N020)/(pokeOccludeGradientMaskPosition-Port_Position1_N020),0.0,1.0));
}
else
{
l9_29=mix(Port_Value2_N020,Port_Value3_N020,clamp((l9_27-pokeOccludeGradientMaskPosition)/(1.0-pokeOccludeGradientMaskPosition),0.0,1.0));
}
l9_28=l9_29;
}
...
bool l9_32;
vec4 l9_33;
if (l9_31&&(20==PreviewNodeID))
{
vec4 l9_34=vec4(l9_28,l9_28,l9_28,1.0);
l9_34.w=1.0;
l9_33=l9_34;
l9_32=true;
}
...
float l9_35=l9_25.z*l9_28;
vec4 l9_36=vec4(1.0-pokePinchBlend)*vec4(Port_Value1_N000,Port_Value2_N000,Port_Value3_N000,l9_35);
float l9_37=l9_36.w;
...
#if (sc_FramebufferFetch)
{
l9_53=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_53=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_54,sc_ScreenTextureLayout,l9_55).xy,0.0);
}
#endif
vec3 l9_56=mix(l9_53.xyz,definedBlend(l9_53.xyz,l9_36.xyz).xyz,vec3(l9_37));
...
#if (sc_Voxelization)
{
l9_58=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_59;
#if (sc_OutputBounds)
{
float l9_60=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_59=vec4(l9_60,1.0-l9_60,1.0,1.0);
}
#else
{
vec4 l9_61;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_61=vec4(mix(vec3(1.0),l9_36.xyz,vec3(l9_37)),l9_37);
}
#else
{
vec4 l9_62;
...
#endif
l9_62=vec4(l9_36.xyz*l9_63,l9_63);
}
#else
{
l9_62=l9_36;
...
vec4 l9_66=sc_OutputMotionVectorIfNeeded(max(l9_64,vec4(0.0)));
