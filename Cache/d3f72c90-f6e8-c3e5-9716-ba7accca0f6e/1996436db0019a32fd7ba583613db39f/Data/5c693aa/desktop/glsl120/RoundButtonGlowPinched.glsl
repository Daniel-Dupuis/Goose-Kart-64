...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glow_map 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glow_map 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int glow_mapLayout 79 0
...
vec2 l9_1=varTex01.xy+Port_Offset_N009;
int l9_2;
...
#endif
vec3 l9_53=mix(l9_50.xyz,definedBlend(l9_50.xyz,l9_28.xyz).xyz,vec3(l9_28.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_58=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_28.w)),l9_28.w);
}
#else
{
vec4 l9_59;
...
#endif
l9_59=vec4(l9_28.xyz*l9_60,l9_60);
}
#else
{
l9_59=l9_28;
...
vec4 l9_63=sc_OutputMotionVectorIfNeeded(max(l9_61,vec4(0.0)));
