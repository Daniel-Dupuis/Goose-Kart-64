...
float l9_34=clamp(length((varTex01.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_35;
...
l9_46.w=l9_43;
vec2 l9_47=((varTex01.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
...
#if (sc_FramebufferFetch)
{
l9_116=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_116=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_117,sc_ScreenTextureLayout,l9_118).xy,0.0);
}
#endif
vec3 l9_119=mix(l9_116.xyz,definedBlend(l9_116.xyz,l9_99.xyz).xyz,vec3(l9_100));
...
#if (sc_Voxelization)
{
l9_121=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_122;
#if (sc_OutputBounds)
{
float l9_123=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_122=vec4(l9_123,1.0-l9_123,1.0,1.0);
}
#else
{
vec4 l9_124;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_124=vec4(mix(vec3(1.0),l9_99.xyz,vec3(l9_100)),l9_100);
}
#else
{
vec4 l9_125;
...
#endif
l9_125=vec4(l9_99.xyz*l9_126,l9_126);
}
#else
{
l9_125=l9_99;
...
vec4 l9_129=sc_OutputMotionVectorIfNeeded(max(l9_127,vec4(0.0)));
vec4 l9_130=clamp(l9_129,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_131=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_131-0.0039215689)),min(1.0,l9_131+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_132=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#endif
int l9_133=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_132).xy);
float l9_134=packValue(l9_133);
int l9_141=int(l9_130.w*255.0);
float l9_142=packValue(l9_141);
sc_writeFragData0Internal(vec4(packValue(l9_133),packValue(l9_133),packValue(l9_133),packValue(l9_133)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_134,packValue(l9_133),packValue(l9_133),packValue(l9_133)));
sc_writeFragData2(vec4(l9_142,packValue(l9_141),packValue(l9_141),packValue(l9_141)));
...
if (l9_150==0)
{
l9_153=texture2D(sc_OITAlpha0,l9_145);
l9_152=texture2D(sc_OITDepthLow0,l9_145);
l9_151=texture2D(sc_OITDepthHigh0,l9_145);
}
else
{
l9_153=vec4(0.0);
...
if (l9_150==1)
{
l9_156=texture2D(sc_OITAlpha1,l9_145);
l9_155=texture2D(sc_OITDepthLow1,l9_145);
l9_154=texture2D(sc_OITDepthHigh1,l9_145);
}
else
{
l9_156=l9_153;
...
if (any(notEqual(l9_154,vec4(0.0)))||any(notEqual(l9_155,vec4(0.0))))
{
int l9_157[8]=l9_146;
unpackValues(l9_154.w,l9_150,l9_157);
unpackValues(l9_154.z,l9_150,l9_157);
unpackValues(l9_154.y,l9_150,l9_157);
unpackValues(l9_154.x,l9_150,l9_157);
unpackValues(l9_155.w,l9_150,l9_157);
unpackValues(l9_155.z,l9_150,l9_157);
unpackValues(l9_155.y,l9_150,l9_157);
unpackValues(l9_155.x,l9_150,l9_157);
int l9_166[8]=l9_147;
unpackValues(l9_156.w,l9_150,l9_166);
unpackValues(l9_156.z,l9_150,l9_166);
unpackValues(l9_156.y,l9_150,l9_166);
unpackValues(l9_156.x,l9_150,l9_166);
}
l9_150++;
continue;
}
...
vec4 l9_171=texture2D(sc_OITFilteredDepthBoundsTexture,l9_145);
vec2 l9_172=l9_171.xy;
int l9_173;
#if (sc_SkinBonesCount>0)
{
l9_173=encodeDepth(((1.0-l9_171.x)*1000.0)+getDepthOrderingEpsilon(),l9_172);
}
#else
{
l9_173=0;
...
#endif
int l9_174=encodeDepth(viewSpaceDepth(),l9_172);
vec4 l9_175;
l9_175=l9_130*l9_130.w;
vec4 l9_176;
int l9_177=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_177<8)
{
int l9_178=l9_146[l9_177];
int l9_179=l9_174-l9_173;
bool l9_180=l9_178<l9_179;
bool l9_181;
if (l9_180)
{
l9_181=l9_146[l9_177]>0;
}
else
{
l9_181=l9_180;
...
if (l9_181)
{
vec3 l9_182=l9_175.xyz*(1.0-(float(l9_147[l9_177])/255.0));
l9_176=vec4(l9_182.x,l9_182.y,l9_182.z,l9_175.w);
}
else
{
l9_176=l9_175;
...
sc_writeFragData0Internal(l9_175,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
