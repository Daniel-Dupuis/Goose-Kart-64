...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_icon 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_icon 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 84 -1
//spec_const int additional_settings_btn_refl_texLayout 85 0
//spec_const int iconLayout 86 0
...
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),additional_settings_btn_refl_texLayout,l9_7);
...
#endif
vec4 l9_32=vec4(Port_Import_N062)*l9_31;
float l9_33=clamp(length((varTex01.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_34;
if (l9_33<Port_Position1_N014)
{
l9_34=mix(Port_Value0_N014,Port_Value1_N014,vec4(clamp(l9_33/Port_Position1_N014,0.0,1.0)));
}
else
{
vec4 l9_35;
if (l9_33<Port_Position2_N014)
{
l9_35=mix(Port_Value1_N014,Port_Value2_N014,vec4(clamp((l9_33-Port_Position1_N014)/(Port_Position2_N014-Port_Position1_N014),0.0,1.0)));
}
else
{
l9_35=mix(Port_Value2_N014,Port_Value3_N014,vec4(clamp((l9_33-Port_Position2_N014)/(1.0-Port_Position2_N014),0.0,1.0)));
}
l9_34=l9_35;
}
vec4 l9_36=l9_32+l9_34;
vec2 l9_37=((varTex01.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
bool l9_38=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_39=l9_37.x;
float l9_40=l9_39;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_41=l9_40;
float l9_42=l9_37.y;
float l9_43=l9_42;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_44=l9_43;
vec2 l9_45;
float l9_46;
...
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_48=l9_41;
float l9_49=1.0;
sc_ClampUV(l9_48,iconUvMinMax.x,iconUvMinMax.z,l9_47,l9_49);
float l9_50=l9_48;
float l9_51=l9_49;
bool l9_52;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_53=l9_44;
float l9_54=l9_51;
sc_ClampUV(l9_53,iconUvMinMax.y,iconUvMinMax.w,l9_52,l9_54);
l9_46=l9_54;
...
{
l9_46=1.0;
l9_45=vec2(l9_41,l9_44);
}
#endif
vec2 l9_55=sc_TransformUV(l9_45,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_38,l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_38,l9_59);
float l9_60=l9_59;
vec3 l9_61=sc_SamplingCoordsViewToGlobal(vec2(l9_56,l9_58),iconLayout,iconGetStereoViewIndex());
vec4 l9_62=texture2D(icon,l9_61.xy,0.0);
vec4 l9_63;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_63=mix(iconBorderColor,l9_62,vec4(l9_60));
}
#else
{
l9_63=l9_62;
...
{
float l9_65=l9_39;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_66=l9_65;
float l9_67=l9_42;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_68=l9_67;
vec2 l9_69;
float l9_70;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_71=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_71=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_72=l9_66;
float l9_73=1.0;
sc_ClampUV(l9_72,iconUvMinMax.x,iconUvMinMax.z,l9_71,l9_73);
float l9_74=l9_72;
float l9_75=l9_73;
bool l9_76;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_77=l9_68;
float l9_78=l9_75;
sc_ClampUV(l9_77,iconUvMinMax.y,iconUvMinMax.w,l9_76,l9_78);
l9_70=l9_78;
...
#endif
vec2 l9_79=sc_TransformUV(l9_69,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_80=l9_79.x;
float l9_81=l9_70;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_38,l9_81);
float l9_82=l9_79.y;
float l9_83=l9_81;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_38,l9_83);
float l9_84=l9_83;
vec3 l9_85=sc_SamplingCoordsViewToGlobal(vec2(l9_80,l9_82),iconLayout,iconGetStereoViewIndex());
vec4 l9_86=texture2D(icon,l9_85.xy,0.0);
vec4 l9_87;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_87=mix(iconBorderColor,l9_86,vec4(l9_84));
}
#else
{
l9_87=l9_86;
...
{
l9_64=Port_Input2_N003;
}
vec4 l9_88=vec4(l9_64);
vec4 l9_89=mix(l9_36,l9_63,l9_88);
float l9_90=l9_89.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_90<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_90<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_94=clamp(dot(l9_89.xyz,vec3(l9_90)),0.0,1.0);
}
#else
{
float l9_95;
...
{
l9_96=(1.0-dot(l9_89.xyz,vec3(0.33333001)))*l9_90;
}
#else
{
float l9_97;
...
{
l9_97=(1.0-clamp(dot(l9_89.xyz,vec3(1.0)),0.0,1.0))*l9_90;
}
#else
{
float l9_98;
...
{
l9_98=clamp(dot(l9_89.xyz,vec3(1.0)),0.0,1.0)*l9_90;
}
#else
{
float l9_99;
#if (sc_BlendMode_Add)
{
l9_99=clamp(dot(l9_89.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_100;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_100=clamp(dot(l9_89.xyz,vec3(1.0)),0.0,1.0)*l9_90;
}
#else
{
float l9_101;
...
{
l9_101=dot(l9_89.xyz,vec3(0.33333001))*l9_90;
}
#else
{
float l9_102;
#if (sc_BlendMode_Min)
{
l9_102=1.0-clamp(dot(l9_89.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_103;
#if (sc_BlendMode_Max)
{
l9_103=clamp(dot(l9_89.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_103=1.0;
...
#endif
l9_91=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_89.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_92);
}
#else
{
vec4 l9_104;
...
#if (sc_FramebufferFetch)
{
l9_106=sc_readFragData0_Platform();
}
#else
{
...
{
l9_108=1-sc_GetStereoViewIndex();
}
#else
{
l9_108=sc_GetStereoViewIndex();
}
#endif
l9_106=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_107,sc_ScreenTextureLayout,l9_108).xy,0.0);
}
#endif
vec3 l9_109=mix(l9_106.xyz,definedBlend(l9_106.xyz,l9_89.xyz).xyz,vec3(l9_90));
...
#if (sc_Voxelization)
{
l9_111=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_112;
#if (sc_OutputBounds)
{
float l9_113=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_112=vec4(l9_113,1.0-l9_113,1.0,1.0);
}
#else
{
vec4 l9_114;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_114=vec4(mix(vec3(1.0),l9_89.xyz,vec3(l9_90)),l9_90);
}
#else
{
vec4 l9_115;
...
#endif
l9_115=vec4(l9_89.xyz*l9_116,l9_116);
}
#else
{
l9_115=l9_89;
...
vec4 l9_119=sc_OutputMotionVectorIfNeeded(max(l9_117,vec4(0.0)));
...
#endif
int l9_123=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_122).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_135).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_140==0)
{
l9_143=texture2D(sc_OITAlpha0,l9_135);
l9_142=texture2D(sc_OITDepthLow0,l9_135);
l9_141=texture2D(sc_OITDepthHigh0,l9_135);
}
else
{
l9_143=vec4(0.0);
...
if (l9_140==1)
{
l9_146=texture2D(sc_OITAlpha1,l9_135);
l9_145=texture2D(sc_OITDepthLow1,l9_135);
l9_144=texture2D(sc_OITDepthHigh1,l9_135);
}
else
{
l9_146=l9_143;
...
vec4 l9_161=texture2D(sc_OITFilteredDepthBoundsTexture,l9_135);
