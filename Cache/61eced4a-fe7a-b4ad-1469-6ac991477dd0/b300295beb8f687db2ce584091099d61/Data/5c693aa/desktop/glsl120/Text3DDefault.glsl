...
//spec_const bool sc_Voxelization 96 0
//spec_const int DROPLIST_BACK_CAP_MODE 97 0
//spec_const int DROPLIST_FRONT_CAP_MODE 98 0
//spec_const int DROPLIST_INNER_EDGE_MODE 99 0
//spec_const int DROPLIST_OUTER_EDGE_MODE 100 0
//spec_const int InnerEdgeTexLayout 101 0
//spec_const int SC_DEVICE_CLASS 102 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_InnerEdgeTex 103 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_backCapTex 104 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_frontCapTex 105 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 106 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_outerEdgeTex 107 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_InnerEdgeTex 108 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_backCapTex 109 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_frontCapTex 110 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 111 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_outerEdgeTex 112 -1
//spec_const int backCapTexLayout 113 0
//spec_const int frontCapTexLayout 114 0
//spec_const int intensityTextureLayout 115 0
//spec_const int outerEdgeTexLayout 116 0
//spec_const int sc_AmbientLightMode0 117 0
//spec_const int sc_AmbientLightMode1 118 0
//spec_const int sc_AmbientLightMode2 119 0
//spec_const int sc_AmbientLightMode_Constant 120 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 121 0
//spec_const int sc_AmbientLightMode_FromCamera 122 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 123 0
//spec_const int sc_AmbientLightsCount 124 0
//spec_const int sc_DepthBufferMode 125 0
//spec_const int sc_DirectionalLightsCount 126 0
//spec_const int sc_EnvLightMode 127 0
//spec_const int sc_EnvmapDiffuseLayout 128 0
//spec_const int sc_EnvmapSpecularLayout 129 0
//spec_const int sc_LightEstimationSGCount 130 0
...
ssGlobals l9_2=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_0,varPosAndMotion.xyz,l9_1,varTex01.xy);
vec4 l9_3;
#if (backCapPBR)
{
vec4 l9_4;
...
#else
{
l9_7=ngsCalculateLighting(l9_6,Port_Opacity_N149,l9_5,varPosAndMotion.xyz,l9_0,Port_Emissive_N149,clamp(backCapMetallic,0.0,1.0),clamp(backCapRoughness,0.0,1.0),Port_AO_N149,Port_SpecularAO_N149);
}
#endif
...
#else
{
l9_13=ngsCalculateLighting(l9_12,Port_Opacity_N118,l9_11,varPosAndMotion.xyz,l9_0,Port_Emissive_N118,clamp(frontCapMetallic,0.0,1.0),clamp(frontCapRoughness,0.0,1.0),Port_AO_N118,Port_SpecularAO_N118);
}
#endif
...
#endif
vec4 l9_15=mix(l9_3,l9_9,vec4(step(varTex01.x,Port_Input1_N054)));
vec4 l9_16;
#if (outerEdgePBR)
{
vec4 l9_17;
...
#else
{
l9_20=ngsCalculateLighting(l9_19,Port_Opacity_N057,l9_18,varPosAndMotion.xyz,l9_0,Port_Emissive_N057,clamp(outerEdgeMetallic,0.0,1.0),clamp(outerRoughness,0.0,1.0),Port_AO_N057,Port_SpecularAO_N057);
}
#endif
...
#else
{
l9_26=ngsCalculateLighting(l9_25,Port_Opacity_N080,l9_24,varPosAndMotion.xyz,l9_0,Port_Emissive_N080,clamp(InnerEdgeMetallic,0.0,1.0),clamp(InnerEdgeRoughness,0.0,1.0),Port_AO_N080,Port_SpecularAO_N080);
}
#endif
...
#endif
vec4 l9_28=mix(l9_16,l9_22,vec4(step(varTex01.y,Port_Input1_N043)));
vec4 l9_29=mix(l9_15,l9_28,vec4(step(varTex01.y,Port_Input1_N014)));
vec4 l9_30;
#if (sc_ProjectiveShadowsCaster)
{
float l9_31;
...
{
float l9_52=l9_29.w;
l9_51=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_52)),l9_52);
}
#else
{
vec4 l9_53;
...
#endif
l9_53=vec4(l9_29.xyz*l9_55,l9_55);
}
#else
{
l9_53=l9_29;
...
vec4 l9_58=sc_OutputMotionVectorIfNeeded(max(l9_56,vec4(0.0)));
