...
vec4 l9_92;
if (l9_91<Port_Position1_N067)
{
l9_92=mix(Port_Value0_N067,Port_Value1_N067,vec4(clamp(l9_91/Port_Position1_N067,0.0,1.0)));
}
else
{
vec4 l9_93;
if (l9_91<Port_Position2_N067)
{
l9_93=mix(Port_Value1_N067,Port_Value2_N067,vec4(clamp((l9_91-Port_Position1_N067)/(Port_Position2_N067-Port_Position1_N067),0.0,1.0)));
}
else
{
vec4 l9_94;
if (l9_91<Port_Position3_N067)
{
l9_94=mix(Port_Value2_N067,Port_Value3_N067,vec4(clamp((l9_91-Port_Position2_N067)/(Port_Position3_N067-Port_Position2_N067),0.0,1.0)));
}
else
{
l9_94=mix(Port_Value3_N067,Port_Value4_N067,vec4(clamp((l9_91-Port_Position3_N067)/(1.0-Port_Position3_N067),0.0,1.0)));
}
l9_93=l9_94;
}
l9_92=l9_93;
}
vec4 l9_95=mix(l9_92,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),l9_2*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
...
#endif
l9_113=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_114,sc_ScreenTextureLayout,l9_115).xy,0.0);
}
#endif
...
vec4 l9_126=sc_OutputMotionVectorIfNeeded(max(l9_124,vec4(0.0)));
vec4 l9_127=clamp(l9_126,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_128=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_128-0.0039215689)),min(1.0,l9_128+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_130=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_129).xy);
float l9_131=packValue(l9_130);
int l9_138=int(l9_127.w*255.0);
float l9_139=packValue(l9_138);
sc_writeFragData0Internal(vec4(packValue(l9_130),packValue(l9_130),packValue(l9_130),packValue(l9_130)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_131,packValue(l9_130),packValue(l9_130),packValue(l9_130)));
sc_writeFragData2(vec4(l9_139,packValue(l9_138),packValue(l9_138),packValue(l9_138)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_142).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_147==0)
{
l9_150=texture2D(sc_OITAlpha0,l9_142);
l9_149=texture2D(sc_OITDepthLow0,l9_142);
l9_148=texture2D(sc_OITDepthHigh0,l9_142);
}
else
{
l9_150=vec4(0.0);
...
if (l9_147==1)
{
l9_153=texture2D(sc_OITAlpha1,l9_142);
l9_152=texture2D(sc_OITDepthLow1,l9_142);
l9_151=texture2D(sc_OITDepthHigh1,l9_142);
}
else
{
l9_153=l9_150;
...
if (any(notEqual(l9_151,vec4(0.0)))||any(notEqual(l9_152,vec4(0.0))))
{
int l9_154[8]=l9_143;
unpackValues(l9_151.w,l9_147,l9_154);
unpackValues(l9_151.z,l9_147,l9_154);
unpackValues(l9_151.y,l9_147,l9_154);
unpackValues(l9_151.x,l9_147,l9_154);
unpackValues(l9_152.w,l9_147,l9_154);
unpackValues(l9_152.z,l9_147,l9_154);
unpackValues(l9_152.y,l9_147,l9_154);
unpackValues(l9_152.x,l9_147,l9_154);
int l9_163[8]=l9_144;
unpackValues(l9_153.w,l9_147,l9_163);
unpackValues(l9_153.z,l9_147,l9_163);
unpackValues(l9_153.y,l9_147,l9_163);
unpackValues(l9_153.x,l9_147,l9_163);
}
l9_147++;
continue;
}
...
vec4 l9_168=texture2D(sc_OITFilteredDepthBoundsTexture,l9_142);
vec2 l9_169=l9_168.xy;
int l9_170;
#if (sc_SkinBonesCount>0)
{
l9_170=encodeDepth(((1.0-l9_168.x)*1000.0)+getDepthOrderingEpsilon(),l9_169);
}
#else
{
l9_170=0;
...
#endif
int l9_171=encodeDepth(viewSpaceDepth(),l9_169);
vec4 l9_172;
l9_172=l9_127*l9_127.w;
vec4 l9_173;
int l9_174=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_174<8)
{
int l9_175=l9_143[l9_174];
int l9_176=l9_171-l9_170;
bool l9_177=l9_175<l9_176;
bool l9_178;
if (l9_177)
{
l9_178=l9_143[l9_174]>0;
}
else
{
l9_178=l9_177;
...
if (l9_178)
{
vec3 l9_179=l9_172.xyz*(1.0-(float(l9_144[l9_174])/255.0));
l9_173=vec4(l9_179.x,l9_179.y,l9_179.z,l9_172.w);
}
else
{
l9_173=l9_172;
