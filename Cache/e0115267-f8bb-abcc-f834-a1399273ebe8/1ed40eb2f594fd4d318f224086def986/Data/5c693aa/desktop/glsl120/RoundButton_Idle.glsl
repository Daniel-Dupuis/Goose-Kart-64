...
#endif
bool l9_8=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0));
float l9_9=l9_6.x;
...
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x,l9_8,l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y,l9_8,l9_27);
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),simple_round_buttonLayout,l9_7);
...
float l9_33=clamp(length((varTex01.xy*Port_Input1_N010)+Port_Input2_N010),0.0,1.0);
vec4 l9_34;
...
vec3 l9_37=(l9_32.xyz+Port_Input1_N002)+l9_34.xyz;
vec4 l9_38=vec4(l9_37.x,l9_37.y,l9_37.z,vec4(0.0).w);
l9_38.w=l9_34.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_34.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_34.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_41=clamp(l9_34.w*2.0,0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_42=clamp(dot(l9_38.xyz,vec3(l9_34.w)),0.0,1.0);
}
#else
{
float l9_43;
...
{
l9_44=(1.0-dot(l9_38.xyz,vec3(0.33333001)))*l9_34.w;
}
#else
{
float l9_45;
...
{
l9_45=(1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0))*l9_34.w;
}
#else
{
float l9_46;
...
{
l9_46=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_34.w;
}
#else
{
float l9_47;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_48=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_34.w;
}
#else
{
float l9_49;
...
{
l9_49=dot(l9_38.xyz,vec3(0.33333001))*l9_34.w;
}
#else
{
float l9_50;
...
#if (sc_FramebufferFetch)
{
l9_54=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_54=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_55,sc_ScreenTextureLayout,l9_56).xy,0.0);
}
#endif
vec3 l9_57=mix(l9_54.xyz,definedBlend(l9_54.xyz,l9_38.xyz).xyz,vec3(l9_34.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_62=vec4(mix(vec3(1.0),l9_38.xyz,vec3(l9_34.w)),l9_34.w);
}
#else
{
vec4 l9_63;
...
#endif
l9_63=vec4(l9_38.xyz*l9_64,l9_64);
}
#else
{
l9_63=l9_38;
...
vec4 l9_67=sc_OutputMotionVectorIfNeeded(max(l9_65,vec4(0.0)));
