...
#endif
sc_writeFragData0Internal(max(l9_638,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_640;
#if (sc_ProjectiveShadowsCaster)
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_668-0.0039215689)),min(1.0,l9_668+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_670),packValue(l9_670),packValue(l9_670),packValue(l9_670)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_671,packValue(l9_670),packValue(l9_670),packValue(l9_670)));
sc_writeFragData2(vec4(l9_679,packValue(l9_678),packValue(l9_678),packValue(l9_678)));
...
sc_writeFragData0Internal(l9_712,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_666,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
