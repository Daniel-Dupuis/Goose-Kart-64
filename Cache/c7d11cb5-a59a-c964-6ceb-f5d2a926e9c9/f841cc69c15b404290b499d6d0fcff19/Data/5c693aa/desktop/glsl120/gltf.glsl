...
#else
{
l9_365=ngsCalculateLighting(l9_364,l9_363,l9_362,varPosAndMotion.xyz,l9_5,max(l9_168,vec3(0.0)),clamp(l9_74,0.0,1.0),clamp(l9_76,0.0,1.0),clamp(l9_75.xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N036);
}
#endif
...
#else
{
l9_368=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_367,varPosAndMotion.xyz,l9_5,Port_Emissive_N405,Port_Metallic_N405,clamp(l9_275,0.0,1.0),vec3(1.0),Port_SpecularAO_N405);
}
#endif
...
#if (sc_Voxelization)
{
l9_404=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_405;
#if (sc_OutputBounds)
{
float l9_406=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_405=vec4(l9_406,1.0-l9_406,1.0,1.0);
}
#else
{
vec4 l9_407;
...
vec4 l9_412=sc_OutputMotionVectorIfNeeded(max(l9_410,vec4(0.0)));
vec4 l9_413=clamp(l9_412,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_414=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_414-0.0039215689)),min(1.0,l9_414+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_415=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_415).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_416=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_415).xy);
float l9_417=packValue(l9_416);
int l9_424=int(l9_413.w*255.0);
float l9_425=packValue(l9_424);
sc_writeFragData0Internal(vec4(packValue(l9_416),packValue(l9_416),packValue(l9_416),packValue(l9_416)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_417,packValue(l9_416),packValue(l9_416),packValue(l9_416)));
sc_writeFragData2(vec4(l9_425,packValue(l9_424),packValue(l9_424),packValue(l9_424)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_428=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_428).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_433==0)
{
l9_436=texture2D(sc_OITAlpha0,l9_428);
l9_435=texture2D(sc_OITDepthLow0,l9_428);
l9_434=texture2D(sc_OITDepthHigh0,l9_428);
}
else
{
l9_436=vec4(0.0);
...
if (l9_433==1)
{
l9_439=texture2D(sc_OITAlpha1,l9_428);
l9_438=texture2D(sc_OITDepthLow1,l9_428);
l9_437=texture2D(sc_OITDepthHigh1,l9_428);
}
else
{
l9_439=l9_436;
...
if (any(notEqual(l9_437,vec4(0.0)))||any(notEqual(l9_438,vec4(0.0))))
{
int l9_440[8]=l9_429;
unpackValues(l9_437.w,l9_433,l9_440);
unpackValues(l9_437.z,l9_433,l9_440);
unpackValues(l9_437.y,l9_433,l9_440);
unpackValues(l9_437.x,l9_433,l9_440);
unpackValues(l9_438.w,l9_433,l9_440);
unpackValues(l9_438.z,l9_433,l9_440);
unpackValues(l9_438.y,l9_433,l9_440);
unpackValues(l9_438.x,l9_433,l9_440);
int l9_449[8]=l9_430;
unpackValues(l9_439.w,l9_433,l9_449);
unpackValues(l9_439.z,l9_433,l9_449);
unpackValues(l9_439.y,l9_433,l9_449);
unpackValues(l9_439.x,l9_433,l9_449);
}
l9_433++;
continue;
}
...
vec4 l9_454=texture2D(sc_OITFilteredDepthBoundsTexture,l9_428);
vec2 l9_455=l9_454.xy;
int l9_456;
#if (sc_SkinBonesCount>0)
{
l9_456=encodeDepth(((1.0-l9_454.x)*1000.0)+getDepthOrderingEpsilon(),l9_455);
}
#else
{
l9_456=0;
...
#endif
int l9_457=encodeDepth(viewSpaceDepth(),l9_455);
vec4 l9_458;
l9_458=l9_413*l9_413.w;
vec4 l9_459;
int l9_460=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_460<8)
{
int l9_461=l9_429[l9_460];
int l9_462=l9_457-l9_456;
bool l9_463=l9_461<l9_462;
bool l9_464;
if (l9_463)
{
l9_464=l9_429[l9_460]>0;
}
else
{
l9_464=l9_463;
...
if (l9_464)
{
vec3 l9_465=l9_458.xyz*(1.0-(float(l9_430[l9_460])/255.0));
l9_459=vec4(l9_465.x,l9_465.y,l9_465.z,l9_458.w);
}
else
{
l9_459=l9_458;
...
sc_writeFragData0Internal(l9_458,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_413,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
