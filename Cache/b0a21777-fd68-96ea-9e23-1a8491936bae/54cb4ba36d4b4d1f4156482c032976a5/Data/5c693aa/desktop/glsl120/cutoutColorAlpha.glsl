...
//sampler sampler Tweak_N10SmpSC 0:17
//sampler sampler Tweak_N31SmpSC 0:18
...
//texture texture2D Tweak_N10 0:0:0:17
//texture texture2D Tweak_N31 0:1:0:18
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N10 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N31 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N10 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N31 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 84 -1
//spec_const int Tweak_N10Layout 85 0
//spec_const int Tweak_N31Layout 86 0
...
#endif
float l9_0=floor(float(AnimatedArrow));
float l9_1;
if (l9_0==0.0)
{
l9_1=Port_Value0_N005;
}
else
{
float l9_2;
if (l9_0==1.0)
{
float l9_3=floor(Port_SpriteCount_N029.x);
float l9_4=floor(Port_SpriteCount_N029.y);
float l9_5=1.0/l9_3;
float l9_6=1.0/l9_4;
float l9_7=floor(mod(((sc_Time.x+Port_SecondOffset_N029)*(ArrowSpeed*Port_Input1_N002))+floor(Port_FrameOffset_N029),min(l9_3*l9_4,floor(Port_MaxFrames_N029))));
int l9_8;
...
#endif
bool l9_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N31)!=0));
float l9_10=(l9_5*Port_UVCoord_N029.x)+(mod(l9_7,l9_3)*l9_5);
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x);
float l9_11=l9_10;
float l9_12=((1.0-l9_6)-(floor(l9_7/l9_3)*l9_6))+(l9_6*Port_UVCoord_N029.y);
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y);
float l9_13=l9_12;
vec2 l9_14;
float l9_15;
...
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0);
}
#endif
float l9_17=l9_11;
float l9_18=1.0;
sc_ClampUV(l9_17,Tweak_N31UvMinMax.x,Tweak_N31UvMinMax.z,l9_16,l9_18);
float l9_19=l9_17;
float l9_20=l9_18;
bool l9_21;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y==3;
}
#else
{
l9_21=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N31)!=0);
}
#endif
float l9_22=l9_13;
float l9_23=l9_20;
sc_ClampUV(l9_22,Tweak_N31UvMinMax.y,Tweak_N31UvMinMax.w,l9_21,l9_23);
l9_15=l9_23;
...
#endif
vec2 l9_24=sc_TransformUV(l9_14,(int(SC_USE_UV_TRANSFORM_Tweak_N31)!=0),Tweak_N31Transform);
float l9_25=l9_24.x;
float l9_26=l9_15;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).x,l9_9,l9_26);
float l9_27=l9_24.y;
float l9_28=l9_26;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N31,SC_SOFTWARE_WRAP_MODE_V_Tweak_N31).y,l9_9,l9_28);
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),Tweak_N31Layout,l9_8);
vec4 l9_31=texture2D(Tweak_N31,l9_30.xy,0.0);
vec4 l9_32;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N31)
{
l9_32=mix(Tweak_N31BorderColor,l9_31,vec4(l9_29));
}
#else
{
l9_32=l9_31;
...
#endif
l9_2=(l9_32.x*Port_Input1_N025)+Port_Input1_N032;
}
else
{
l9_2=Port_Default_N005;
}
l9_1=l9_2;
}
vec2 l9_33=vec2(Port_Value1_N023,l9_1);
vec2 l9_34=(((varTex01.xy-Port_Center_N019)*Port_Scale_N019)+Port_Center_N019)+l9_33;
int l9_35;
...
#endif
bool l9_36=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N10)!=0));
float l9_37=l9_34.x;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x);
float l9_38=l9_37;
float l9_39=l9_34.y;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y);
float l9_40=l9_39;
vec2 l9_41;
float l9_42;
...
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0);
}
#endif
float l9_44=l9_38;
float l9_45=1.0;
sc_ClampUV(l9_44,Tweak_N10UvMinMax.x,Tweak_N10UvMinMax.z,l9_43,l9_45);
float l9_46=l9_44;
float l9_47=l9_45;
bool l9_48;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N10)
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y==3;
}
#else
{
l9_48=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0);
}
#endif
float l9_49=l9_40;
float l9_50=l9_47;
sc_ClampUV(l9_49,Tweak_N10UvMinMax.y,Tweak_N10UvMinMax.w,l9_48,l9_50);
l9_42=l9_50;
...
#endif
vec2 l9_51=sc_TransformUV(l9_41,(int(SC_USE_UV_TRANSFORM_Tweak_N10)!=0),Tweak_N10Transform);
float l9_52=l9_51.x;
float l9_53=l9_42;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).x,l9_36,l9_53);
float l9_54=l9_51.y;
float l9_55=l9_53;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10).y,l9_36,l9_55);
float l9_56=l9_55;
vec3 l9_57=sc_SamplingCoordsViewToGlobal(vec2(l9_52,l9_54),Tweak_N10Layout,l9_35);
vec4 l9_58=texture2D(Tweak_N10,l9_57.xy,0.0);
vec4 l9_59;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N10)
{
l9_59=mix(Tweak_N10BorderColor,l9_58,vec4(l9_56));
}
#else
{
l9_59=l9_58;
...
#endif
vec4 l9_60=mix(YellowColor,WhiteColor,vec4(l9_59.x));
float l9_61=distance(varTex01.xy,Port_Input1_N013);
float l9_62=((smoothstep(Port_Input0_N016,Port_Input1_N016,l9_61)-smoothstep(Port_Input0_N015,Port_Input1_N015,l9_61))+Port_Input1_N018)+l9_59.x;
vec4 l9_63=vec4(l9_60.x,l9_60.y,l9_60.z,vec4(0.0).w);
l9_63.w=l9_62;
...
#endif
l9_79=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_80,sc_ScreenTextureLayout,l9_81).xy,0.0);
}
#endif
...
#endif
int l9_96=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_95).xy);
...
if (l9_113==0)
{
l9_116=texture2D(sc_OITAlpha0,l9_108);
l9_115=texture2D(sc_OITDepthLow0,l9_108);
l9_114=texture2D(sc_OITDepthHigh0,l9_108);
}
else
{
l9_116=vec4(0.0);
...
if (l9_113==1)
{
l9_119=texture2D(sc_OITAlpha1,l9_108);
l9_118=texture2D(sc_OITDepthLow1,l9_108);
l9_117=texture2D(sc_OITDepthHigh1,l9_108);
}
else
{
l9_119=l9_116;
...
vec4 l9_134=texture2D(sc_OITFilteredDepthBoundsTexture,l9_108);
