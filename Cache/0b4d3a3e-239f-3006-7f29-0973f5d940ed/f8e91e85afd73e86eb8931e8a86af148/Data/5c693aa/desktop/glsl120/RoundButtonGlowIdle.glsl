...
#endif
l9_18=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_19,sc_ScreenTextureLayout,l9_20).xy,0.0);
}
#endif
vec3 l9_21=mix(l9_18.xyz,definedBlend(l9_18.xyz,l9_0.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_26=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_27;
