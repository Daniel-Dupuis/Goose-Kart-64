...
#endif
float l9_44=(mix(baseColor,SecondGradient,vec4(varTex01.y))*l9_10).w*l9_11;
...
#if (sc_Voxelization)
{
l9_259=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_260;
#if (sc_OutputBounds)
{
float l9_261=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_260=vec4(l9_261,1.0-l9_261,1.0,1.0);
}
#else
{
vec4 l9_262;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_262=vec4(mix(vec3(1.0),l9_240.xyz,vec3(l9_239)),l9_239);
}
#else
{
vec4 l9_263;
...
#endif
l9_263=vec4(l9_240.xyz*l9_264,l9_264);
}
#else
{
l9_263=l9_240;
...
vec4 l9_267=sc_OutputMotionVectorIfNeeded(max(l9_265,vec4(0.0)));
