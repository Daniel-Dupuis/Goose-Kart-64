...
ssGlobals l9_6=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_0,varPosAndMotion.xyz,varPosAndMotion.xyz,l9_1,l9_2,l9_3,varTex01.xy,varTex01.zw,l9_5,varColor);
vec4 l9_7;
...
#else
{
l9_368=ngsCalculateLighting(l9_367,l9_366,l9_365,varPosAndMotion.xyz,l9_0,max(l9_170,vec3(0.0)),clamp(l9_76,0.0,1.0),clamp(l9_78,0.0,1.0),clamp(l9_77.xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N036);
}
#endif
...
#else
{
l9_371=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_370,varPosAndMotion.xyz,l9_0,Port_Emissive_N405,Port_Metallic_N405,clamp(l9_278,0.0,1.0),vec3(1.0),Port_SpecularAO_N405);
}
#endif
...
vec4 l9_417=sc_OutputMotionVectorIfNeeded(max(l9_415,vec4(0.0)));
