...
float l9_116=max((((((mix(l9_74.x,l9_97.y,clamp((((clamp((smoothstep(l9_101,l9_103+l9_101,l9_24)-smoothstep(l9_99,l9_103+l9_99,l9_24))+0.001,Port_Input1_N051+0.001,Port_Input2_N051+0.001)-0.001)*l9_104)*Port_Input1_N101)+0.001,Port_Input1_N102+0.001,Port_Input2_N102+0.001)-0.001)+Port_Input1_N069)*(smoothstep(Port_Input0_N026,Port_Input1_N026,l9_24)*(1.0-smoothstep(l9_105,l9_105+Port_Input1_N020,distance(varTex01.xy,Port_Input1_N014)))))*Port_Input2_N006)*((((smoothstep(Port_Input0_N103,(((switchSize-Port_RangeMinA_N148)/((Port_RangeMaxA_N148-Port_RangeMinA_N148)+1e-06))*(Port_RangeMaxB_N148-Port_RangeMinB_N148))+Port_RangeMinB_N148,l9_24)-Port_RangeMinA_N105)/((Port_RangeMaxA_N105-Port_RangeMinA_N105)+1e-06))*(Port_RangeMaxB_N105-Port_RangeMinB_N105))+Port_RangeMinB_N105))+l9_25)+Port_Input2_N027,l9_107);
vec4 l9_117=vec4(l9_38.x,l9_38.y,l9_38.z,vec4(0.0).w);
l9_117.w=l9_116;
if ((float(l9_116==Port_Input1_N064)*1.0)!=0.0)
{
discard;
}
...
{
l9_120=clamp(l9_116*2.0,0.0,1.0);
}
#else
{
float l9_121;
...
{
l9_121=clamp(dot(l9_117.xyz,vec3(l9_116)),0.0,1.0);
}
#else
{
float l9_122;
...
{
l9_123=(1.0-dot(l9_117.xyz,vec3(0.33333001)))*l9_116;
}
#else
{
float l9_124;
...
{
l9_124=(1.0-clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0))*l9_116;
}
#else
{
float l9_125;
...
{
l9_125=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0)*l9_116;
}
#else
{
float l9_126;
#if (sc_BlendMode_Add)
{
l9_126=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_127;
...
{
l9_128=dot(l9_117.xyz,vec3(0.33333001))*l9_116;
}
#else
{
float l9_129;
#if (sc_BlendMode_Min)
{
l9_129=1.0-clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_130;
#if (sc_BlendMode_Max)
{
l9_130=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_130=1.0;
...
#endif
l9_118=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_117.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_119);
}
#else
{
vec4 l9_131;
...
#endif
l9_133=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_134,sc_ScreenTextureLayout,l9_135).xy,0.0);
}
#endif
vec3 l9_136=mix(l9_133.xyz,definedBlend(l9_133.xyz,l9_117.xyz).xyz,vec3(l9_116));
...
#if (sc_Voxelization)
{
l9_138=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_139;
#if (sc_OutputBounds)
{
float l9_140=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_139=vec4(l9_140,1.0-l9_140,1.0,1.0);
}
#else
{
vec4 l9_141;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_141=vec4(mix(vec3(1.0),l9_117.xyz,vec3(l9_116)),l9_116);
}
#else
{
vec4 l9_142;
...
#endif
l9_142=vec4(l9_117.xyz*l9_143,l9_143);
}
#else
{
l9_142=l9_117;
...
vec4 l9_146=sc_OutputMotionVectorIfNeeded(max(l9_144,vec4(0.0)));
