...
float l9_1=radians(grainRotation.z);
float l9_2=sin(l9_1);
float l9_3=cos(l9_1);
vec2 l9_4=vec2(l9_0.xz)-Port_Center_N013;
vec2 l9_5=vec2(dot(vec2(l9_3,l9_2),l9_4),dot(vec2(-l9_2,l9_3),l9_4))+Port_Center_N013;
float l9_6=radians(grainRotation.x);
float l9_7=sin(l9_6);
float l9_8=cos(l9_6);
vec2 l9_9=vec2(l9_5.x,l9_0.y)-Port_Center_N016;
vec2 l9_10=vec2(dot(vec2(l9_8,l9_7),l9_9),dot(vec2(-l9_7,l9_8),l9_9))+Port_Center_N016;
float l9_11=l9_10.x;
float l9_12=radians(grainRotation.y);
float l9_13=sin(l9_12);
float l9_14=cos(l9_12);
vec2 l9_15=vec2(l9_5.y,l9_10.y)-Port_Center_N020;
vec2 l9_16=vec2(dot(vec2(l9_14,l9_13),l9_15),dot(vec2(-l9_13,l9_14),l9_15))+Port_Center_N020;
float l9_17=l9_16.y;
vec3 l9_18=vec3(Port_Value1_N001,knottyness,Port_Value3_N001);
...
vec2 l9_22=(vec2(l9_11,l9_17)*vec2(l9_21.yz))+vec2(Port_Import_N059.yz);
float l9_23=snoise(vec2(floor(l9_22.x*10000.0)*9.9999997e-05,floor(l9_22.y*10000.0)*9.9999997e-05)*(Port_Scale_N081*0.5));
vec2 l9_24=(vec2(l9_17,l9_16.x)*vec2(l9_21.zx))+vec2(Port_Import_N059.zx);
float l9_25=snoise(vec2(floor(l9_24.x*10000.0)*9.9999997e-05,floor(l9_24.y*10000.0)*9.9999997e-05)*(Port_Scale_N089*0.5));
vec2 l9_26=(vec2(l9_16.x,l9_11)*vec2(l9_21.xy))+vec2(Port_Import_N059.xy);
float l9_27=snoise(vec2(floor(l9_26.x*10000.0)*9.9999997e-05,floor(l9_26.y*10000.0)*9.9999997e-05)*(Port_Scale_N094*0.5));
vec3 l9_28;
#if (!sc_ProjectiveShadowsCaster)
{
l9_28=normalize(varNormalAndMotion.xyz);
}
#else
{
l9_28=vec3(0.0);
...
#endif
uvec3 l9_29=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_29.x,l9_29.y,l9_29.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_30=l9_28/vec3(dot(abs(l9_28),vec3(1.0)));
vec2 l9_31=vec2(clamp(-l9_30.z,0.0,1.0));
vec2 l9_32=l9_30.xy;
uint l9_33=packHalf2x16(l9_32+mix(-l9_31,l9_31,step(vec2(0.0),l9_32)));
uvec2 l9_34=uvec2(l9_33&65535u,l9_33>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_34.x,l9_34.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
sc_RayTracingNormalAndMore.z=0u;
sc_RayTracingNormalAndMore.w=uint(clamp((1.0-smoothstep(Port_Input0_N167,(Port_Import_N153*Port_Input1_N154)+Port_Import_N153,abs(sin(sin((((Port_Input0_N151*((((floor(((l9_23*0.5)+0.5)*10000.0)*9.9999997e-05)+(floor(((l9_25*0.5)+0.5)*10000.0)*9.9999997e-05))+(floor(((l9_27*0.5)+0.5)*10000.0)*9.9999997e-05))*Port_Input1_N096))*scale)*Port_Input1_N157)*3.1415927)+(Port_Input0_N162*Port_Import_N153)))*Port_Input1_N166))+roughness,0.0,1.0)*1000.0)|((sc_RayTracingReceiverId%32u)<<10u);
}
...
vec4 ngsCalculateLighting(vec3 albedo,float opacity,vec3 normal,vec3 position,vec3 viewDir,vec3 emissive,float metallic,float roughness_1,vec3 ao,vec3 specularAO)
{
float l9_0=opacity;
...
float l9_7=radians(grainRotation.z);
float l9_8=sin(l9_7);
float l9_9=cos(l9_7);
vec2 l9_10=vec2(l9_1.xz)-Port_Center_N013;
vec2 l9_11=vec2(dot(vec2(l9_9,l9_8),l9_10),dot(vec2(-l9_8,l9_9),l9_10))+Port_Center_N013;
float l9_12=radians(grainRotation.x);
float l9_13=sin(l9_12);
float l9_14=cos(l9_12);
vec2 l9_15=vec2(l9_11.x,l9_1.y)-Port_Center_N016;
vec2 l9_16=vec2(dot(vec2(l9_14,l9_13),l9_15),dot(vec2(-l9_13,l9_14),l9_15))+Port_Center_N016;
float l9_17=l9_16.x;
float l9_18=radians(grainRotation.y);
float l9_19=sin(l9_18);
float l9_20=cos(l9_18);
vec2 l9_21=vec2(l9_11.y,l9_16.y)-Port_Center_N020;
vec2 l9_22=vec2(dot(vec2(l9_20,l9_19),l9_21),dot(vec2(-l9_19,l9_20),l9_21))+Port_Center_N020;
float l9_23=l9_22.y;
vec3 l9_24=vec3(Port_Value1_N001,knottyness,Port_Value3_N001);
...
vec2 l9_28=(vec2(l9_17,l9_23)*vec2(l9_27.yz))+vec2(Port_Import_N059.yz);
float l9_29=snoise(vec2(floor(l9_28.x*10000.0)*9.9999997e-05,floor(l9_28.y*10000.0)*9.9999997e-05)*(Port_Scale_N081*0.5));
vec2 l9_30=(vec2(l9_23,l9_22.x)*vec2(l9_27.zx))+vec2(Port_Import_N059.zx);
float l9_31=snoise(vec2(floor(l9_30.x*10000.0)*9.9999997e-05,floor(l9_30.y*10000.0)*9.9999997e-05)*(Port_Scale_N089*0.5));
vec2 l9_32=(vec2(l9_22.x,l9_17)*vec2(l9_27.xy))+vec2(Port_Import_N059.xy);
float l9_33=snoise(vec2(floor(l9_32.x*10000.0)*9.9999997e-05,floor(l9_32.y*10000.0)*9.9999997e-05)*(Port_Scale_N094*0.5));
float l9_34=smoothstep(Port_Input0_N167,(Port_Import_N153*Port_Input1_N154)+Port_Import_N153,abs(sin(sin((((Port_Input0_N151*((((floor(((l9_29*0.5)+0.5)*10000.0)*9.9999997e-05)+(floor(((l9_31*0.5)+0.5)*10000.0)*9.9999997e-05))+(floor(((l9_33*0.5)+0.5)*10000.0)*9.9999997e-05))*Port_Input1_N096))*scale)*Port_Input1_N157)*3.1415927)+(Port_Input0_N162*Port_Import_N153)))*Port_Input1_N166);
float l9_35=1.0-l9_34;
vec3 l9_36;
#if (!sc_ProjectiveShadowsCaster)
{
l9_36=l9_2;
...
#endif
vec3 l9_37=max(((baseColor*vec4(l9_34))+(lineColor*vec4(l9_35))).xyz,vec3(0.0));
vec4 l9_38;
#if (sc_ProjectiveShadowsCaster)
{
l9_38=vec4(l9_37,Port_Opacity_N176);
}
#else
{
l9_38=ngsCalculateLighting(l9_37,Port_Opacity_N176,l9_36,l9_3,l9_4,Port_Emissive_N176,Port_Metallic_N176,clamp(l9_35+roughness,0.0,1.0),Port_AO_N176,Port_SpecularAO_N176);
}
#endif
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_44=clamp(l9_39.w*2.0,0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_39.xyz,vec3(l9_39.w)),0.0,1.0);
}
#else
{
float l9_46;
...
#if (sc_BlendMode_Multiply)
{
l9_47=(1.0-dot(l9_39.xyz,vec3(0.33333001)))*l9_39.w;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0))*l9_39.w;
}
#else
{
float l9_49;
#if (sc_BlendMode_ColoredGlass)
{
l9_49=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*l9_39.w;
}
#else
{
float l9_50;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_51=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*l9_39.w;
}
#else
{
float l9_52;
...
{
l9_52=dot(l9_39.xyz,vec3(0.33333001))*l9_39.w;
}
#else
{
float l9_53;
...
{
vec3 l9_57=sc_GetFramebufferColor().xyz;
vec3 l9_58=mix(l9_57,definedBlend(l9_57,l9_39.xyz).xyz,vec3(l9_39.w));
...
#if (sc_Voxelization)
{
l9_60=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_61;
#if (sc_OutputBounds)
{
float l9_62=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_61=vec4(l9_62,1.0-l9_62,1.0,1.0);
}
#else
{
vec4 l9_63;
...
{
float l9_64=l9_39.w;
l9_63=vec4(mix(vec3(1.0),l9_39.xyz,vec3(l9_64)),l9_64);
}
#else
{
vec4 l9_65;
...
#endif
l9_65=vec4(l9_39.xyz*l9_67,l9_67);
}
#else
{
l9_65=l9_39;
