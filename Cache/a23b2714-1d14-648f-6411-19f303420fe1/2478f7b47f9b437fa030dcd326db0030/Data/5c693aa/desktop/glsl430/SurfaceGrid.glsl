...
#endif
sc_writeFragData0Internal(max(l9_172,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_174;
...
#if (sc_FramebufferFetch)
{
l9_189=sc_readFragData0_Platform();
}
#else
{
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_204-0.0039215689)),min(1.0,l9_204+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_206),packValue(l9_206),packValue(l9_206),packValue(l9_206)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_207,packValue(l9_206),packValue(l9_206),packValue(l9_206)));
sc_writeFragData2(vec4(l9_215,packValue(l9_214),packValue(l9_214),packValue(l9_214)));
