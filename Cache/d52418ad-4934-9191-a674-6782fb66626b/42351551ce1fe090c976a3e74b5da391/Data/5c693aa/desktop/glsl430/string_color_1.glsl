...
#endif
sc_writeFragData0Internal(max(l9_208,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_210;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_212=clamp(l9_207.w*2.0,0.0,1.0);
}
#else
{
float l9_213;
...
{
l9_213=clamp(dot(l9_207.xyz,vec3(l9_207.w)),0.0,1.0);
}
#else
{
float l9_214;
...
#if (sc_BlendMode_Multiply)
{
l9_215=(1.0-dot(l9_207.xyz,vec3(0.33333001)))*l9_207.w;
}
#else
{
float l9_216;
...
{
l9_216=(1.0-clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0))*l9_207.w;
}
#else
{
float l9_217;
#if (sc_BlendMode_ColoredGlass)
{
l9_217=clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0)*l9_207.w;
}
#else
{
float l9_218;
#if (sc_BlendMode_Add)
{
l9_218=clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_219;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_219=clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0)*l9_207.w;
}
#else
{
float l9_220;
...
{
l9_220=dot(l9_207.xyz,vec3(0.33333001))*l9_207.w;
}
#else
{
float l9_221;
#if (sc_BlendMode_Min)
{
l9_221=1.0-clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_222;
#if (sc_BlendMode_Max)
{
l9_222=clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_222=1.0;
...
#endif
l9_210=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_207.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_211);
}
#else
{
vec4 l9_223;
...
vec3 l9_226=mix(l9_225,definedBlend(l9_225,l9_207.xyz).xyz,vec3(l9_207.w));
...
#if (sc_Voxelization)
{
l9_228=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_229;
#if (sc_OutputBounds)
{
float l9_230=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_229=vec4(l9_230,1.0-l9_230,1.0,1.0);
}
#else
{
vec4 l9_231;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_232=l9_207.w;
l9_231=vec4(mix(vec3(1.0),l9_207.xyz,vec3(l9_232)),l9_232);
}
#else
{
vec4 l9_233;
...
{
float l9_234=l9_207.w;
float l9_235;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_235=clamp(l9_234,0.0,1.0);
}
#else
{
l9_235=l9_234;
...
#endif
l9_233=vec4(l9_207.xyz*l9_235,l9_235);
}
#else
{
l9_233=l9_207;
...
vec4 l9_238=sc_OutputMotionVectorIfNeeded(max(l9_236,vec4(0.0)));
