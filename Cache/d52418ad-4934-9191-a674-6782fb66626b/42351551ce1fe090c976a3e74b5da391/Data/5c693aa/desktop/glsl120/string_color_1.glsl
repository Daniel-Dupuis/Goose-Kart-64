...
#if (sc_SSAOEnabled)
{
l9_125=evaluateSSAO(varPosAndMotion.xyz);
}
#else
{
l9_125=Port_AO_N036;
...
SurfaceProperties l9_127=SurfaceProperties(l9_126,l9_119,l9_123,varPosAndMotion.xyz,l9_0,0.0,1.0,l9_124,l9_125,vec3(1.0),vec3(1.0),vec3(0.039999999));
...
{
vec3 l9_167=sc_PointLights[l9_165].position-varPosAndMotion.xyz;
...
#if (sc_Voxelization)
{
l9_256=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_257;
#if (sc_OutputBounds)
{
float l9_258=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_257=vec4(l9_258,1.0-l9_258,1.0,1.0);
}
#else
{
vec4 l9_259;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_260=l9_237.w;
l9_259=vec4(mix(vec3(1.0),l9_237.xyz,vec3(l9_260)),l9_260);
}
#else
{
vec4 l9_261;
...
{
float l9_262=l9_237.w;
float l9_263;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_263=clamp(l9_262,0.0,1.0);
}
#else
{
l9_263=l9_262;
...
#endif
l9_261=vec4(l9_237.xyz*l9_263,l9_263);
}
#else
{
l9_261=l9_237;
...
vec4 l9_266=sc_OutputMotionVectorIfNeeded(max(l9_264,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_268-0.0039215689)),min(1.0,l9_268+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_269=sc_ScreenCoordsGlobalToView(l9_1);
...
sc_writeFragData0Internal(vec4(packValue(l9_270),packValue(l9_270),packValue(l9_270),packValue(l9_270)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_282=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
