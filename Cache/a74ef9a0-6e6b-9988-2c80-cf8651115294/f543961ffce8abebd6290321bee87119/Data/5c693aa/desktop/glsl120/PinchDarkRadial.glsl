...
#if (sc_Voxelization)
{
l9_260=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_261;
#if (sc_OutputBounds)
{
float l9_262=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_261=vec4(l9_262,1.0-l9_262,1.0,1.0);
}
#else
{
vec4 l9_263;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_263=vec4(mix(vec3(1.0),l9_241.xyz,vec3(l9_240)),l9_240);
}
#else
{
vec4 l9_264;
...
#endif
l9_264=vec4(l9_241.xyz*l9_265,l9_265);
}
#else
{
l9_264=l9_241;
...
vec4 l9_268=sc_OutputMotionVectorIfNeeded(max(l9_266,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_270-0.0039215689)),min(1.0,l9_270+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_271=sc_ScreenCoordsGlobalToView(l9_1);
...
sc_writeFragData0Internal(vec4(packValue(l9_272),packValue(l9_272),packValue(l9_272),packValue(l9_272)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_284=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
...
sc_writeFragData0Internal(l9_314,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
