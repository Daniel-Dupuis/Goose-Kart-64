...
vec4 l9_92;
if (l9_91<Port_Position1_N030)
{
l9_92=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_91/Port_Position1_N030,0.0,1.0)));
}
else
{
vec4 l9_93;
if (l9_91<Port_Position2_N030)
{
l9_93=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_91-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0)));
}
else
{
vec4 l9_94;
if (l9_91<Port_Position3_N030)
{
l9_94=mix(Port_Value2_N030,Port_Value3_N030,vec4(clamp((l9_91-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0)));
}
else
{
vec4 l9_95;
if (l9_91<Port_Position4_N030)
{
l9_95=mix(Port_Value3_N030,Port_Value4_N030,vec4(clamp((l9_91-Port_Position3_N030)/(Port_Position4_N030-Port_Position3_N030),0.0,1.0)));
}
else
{
l9_95=mix(Port_Value4_N030,Port_Value5_N030,vec4(clamp((l9_91-Port_Position4_N030)/(1.0-Port_Position4_N030),0.0,1.0)));
}
l9_94=l9_95;
}
l9_93=l9_94;
...
vec4 l9_96=mix(l9_92,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),l9_2*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
vec4 l9_97=l9_59+l9_96;
float l9_98=l9_97.w;
...
#if (sc_FramebufferFetch)
{
l9_114=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_114=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_115,sc_ScreenTextureLayout,l9_116).xy,0.0);
}
#endif
vec3 l9_117=mix(l9_114.xyz,definedBlend(l9_114.xyz,l9_97.xyz).xyz,vec3(l9_98));
vec4 l9_118=vec4(l9_117.x,l9_117.y,l9_117.z,vec4(0.0).w);
l9_118.w=1.0;
l9_113=l9_118;
}
#else
...
#if (sc_Voxelization)
{
l9_119=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_120;
#if (sc_OutputBounds)
{
float l9_121=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_120=vec4(l9_121,1.0-l9_121,1.0,1.0);
}
#else
{
vec4 l9_122;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_122=vec4(mix(vec3(1.0),l9_97.xyz,vec3(l9_98)),l9_98);
}
#else
{
vec4 l9_123;
...
#endif
l9_123=vec4(l9_97.xyz*l9_124,l9_124);
}
#else
{
l9_123=l9_97;
...
vec4 l9_127=sc_OutputMotionVectorIfNeeded(max(l9_125,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_129-0.0039215689)),min(1.0,l9_129+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_131),packValue(l9_131),packValue(l9_131),packValue(l9_131)),sc_UniformConstants.x,sc_ShaderCacheConstant);
