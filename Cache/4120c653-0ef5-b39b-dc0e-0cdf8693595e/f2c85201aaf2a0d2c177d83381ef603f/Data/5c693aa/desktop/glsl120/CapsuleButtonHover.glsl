...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 90 -1
//spec_const int capsule_btn_refl_tex_1Layout 91 0
//spec_const int capsule_btn_refl_tex_2Layout 92 0
//spec_const int capsule_btn_refl_tex_3Layout 93 0
...
vec3 l9_63=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_60*l9_62,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
bool l9_64=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0));
float l9_65=l9_63.x;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_66=l9_65;
float l9_67=l9_63.y;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_68=l9_67;
vec2 l9_69;
float l9_70;
...
{
l9_71=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
l9_71=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_72=l9_66;
float l9_73=1.0;
sc_ClampUV(l9_72,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_71,l9_73);
float l9_74=l9_72;
float l9_75=l9_73;
bool l9_76;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_77=l9_68;
float l9_78=l9_75;
sc_ClampUV(l9_77,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_76,l9_78);
l9_70=l9_78;
...
#endif
vec2 l9_79=sc_TransformUV(l9_69,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_80=l9_79.x;
float l9_81=l9_70;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,l9_64,l9_81);
float l9_82=l9_79.y;
float l9_83=l9_81;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,l9_64,l9_83);
float l9_84=l9_83;
vec3 l9_85=sc_SamplingCoordsViewToGlobal(vec2(l9_80,l9_82),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_86=texture2D(capsule_btn_refl_tex_1,l9_85.xy,0.0);
vec4 l9_87;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_87=mix(capsule_btn_refl_tex_1BorderColor,l9_86,vec4(l9_84));
}
#else
{
l9_87=l9_86;
...
#endif
vec4 l9_88=vec4(Port_Import_N027)*l9_87;
float l9_89=clamp(l9_88.x,0.0,1.0);
vec4 l9_90;
if (l9_89<Port_Position1_N016)
{
l9_90=mix(Port_Value0_N016,Port_Value1_N016,vec4(clamp(l9_89/Port_Position1_N016,0.0,1.0)));
}
else
{
vec4 l9_91;
if (l9_89<Port_Position2_N016)
{
l9_91=mix(Port_Value1_N016,Port_Value2_N016,vec4(clamp((l9_89-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0)));
}
else
{
vec4 l9_92;
if (l9_89<Port_Position3_N016)
{
l9_92=mix(Port_Value2_N016,Port_Value3_N016,vec4(clamp((l9_89-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0)));
}
else
{
l9_92=mix(Port_Value3_N016,Port_Value4_N016,vec4(clamp((l9_89-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0)));
}
l9_91=l9_92;
}
l9_90=l9_91;
}
vec2 l9_93=((varTex01.xy-Port_Center_N019)*Port_Scale_N019)+Port_Center_N019;
float l9_94=l9_93.x;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_95=l9_94;
float l9_96=l9_93.y;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_97=l9_96;
vec2 l9_98;
float l9_99;
#if (SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)
...
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_101=l9_95;
float l9_102=1.0;
sc_ClampUV(l9_101,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_100,l9_102);
float l9_103=l9_101;
float l9_104=l9_102;
bool l9_105;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_106=l9_97;
float l9_107=l9_104;
sc_ClampUV(l9_106,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_105,l9_107);
l9_99=l9_107;
...
#endif
vec2 l9_108=sc_TransformUV(l9_98,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_109=l9_108.x;
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,l9_64,l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,l9_64,l9_112);
float l9_113=l9_112;
vec3 l9_114=sc_SamplingCoordsViewToGlobal(vec2(l9_109,l9_111),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_115=texture2D(capsule_btn_refl_tex_1,l9_114.xy,0.0);
vec4 l9_116;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_116=mix(capsule_btn_refl_tex_1BorderColor,l9_115,vec4(l9_113));
}
#else
{
l9_116=l9_115;
...
#endif
vec4 l9_117=smoothstep(Port_Input0_N020,Port_Input1_N020,l9_116);
vec4 l9_118=mix(l9_90,Port_Input1_N050,mix(Port_Input0_N048,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),l9_2*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023),l9_117));
float l9_119=radians(Port_Rotation_N035);
float l9_120=clamp((vec2(dot(vec2(cos(l9_119),sin(l9_119)),l9_93-Port_Center_N035),0.0)+Port_Center_N035).x,0.0,1.0);
float l9_121;
if (l9_120<Port_Position1_N030)
{
l9_121=mix(Port_Value0_N030,Port_Value1_N030,clamp(l9_120/Port_Position1_N030,0.0,1.0));
}
else
{
float l9_122;
if (l9_120<Port_Position2_N030)
{
l9_122=mix(Port_Value1_N030,Port_Value2_N030,clamp((l9_120-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0));
}
else
{
float l9_123;
if (l9_120<Port_Position3_N030)
{
l9_123=mix(Port_Value2_N030,Port_Value3_N030,clamp((l9_120-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0));
}
else
{
l9_123=mix(Port_Value3_N030,Port_Value4_N030,clamp((l9_120-Port_Position3_N030)/(1.0-Port_Position3_N030),0.0,1.0));
}
l9_122=l9_123;
}
l9_121=l9_122;
}
vec4 l9_124=vec4(l9_118.x,l9_118.y,l9_118.z,vec4(0.0).w);
l9_124.w=l9_121;
vec4 l9_125=l9_59+l9_124;
float l9_126=l9_125.w;
...
{
l9_129=clamp(l9_126*2.0,0.0,1.0);
}
#else
{
float l9_130;
...
{
l9_130=clamp(dot(l9_125.xyz,vec3(l9_126)),0.0,1.0);
}
#else
{
float l9_131;
...
{
l9_132=(1.0-dot(l9_125.xyz,vec3(0.33333001)))*l9_126;
}
#else
{
float l9_133;
...
{
l9_133=(1.0-clamp(dot(l9_125.xyz,vec3(1.0)),0.0,1.0))*l9_126;
}
#else
{
float l9_134;
...
{
l9_134=clamp(dot(l9_125.xyz,vec3(1.0)),0.0,1.0)*l9_126;
}
#else
{
float l9_135;
#if (sc_BlendMode_Add)
{
l9_135=clamp(dot(l9_125.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_136;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_136=clamp(dot(l9_125.xyz,vec3(1.0)),0.0,1.0)*l9_126;
}
#else
{
float l9_137;
...
{
l9_137=dot(l9_125.xyz,vec3(0.33333001))*l9_126;
}
#else
{
float l9_138;
#if (sc_BlendMode_Min)
{
l9_138=1.0-clamp(dot(l9_125.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_139;
#if (sc_BlendMode_Max)
{
l9_139=clamp(dot(l9_125.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_139=1.0;
...
#endif
l9_127=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_125.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_128);
}
#else
{
vec4 l9_140;
...
#endif
l9_142=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_143,sc_ScreenTextureLayout,l9_144).xy,0.0);
}
#endif
vec3 l9_145=mix(l9_142.xyz,definedBlend(l9_142.xyz,l9_125.xyz).xyz,vec3(l9_126));
...
#if (sc_Voxelization)
{
l9_147=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_148;
#if (sc_OutputBounds)
{
float l9_149=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_148=vec4(l9_149,1.0-l9_149,1.0,1.0);
}
#else
{
vec4 l9_150;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_150=vec4(mix(vec3(1.0),l9_125.xyz,vec3(l9_126)),l9_126);
}
#else
{
vec4 l9_151;
...
#endif
l9_151=vec4(l9_125.xyz*l9_152,l9_152);
}
#else
{
l9_151=l9_125;
...
vec4 l9_155=sc_OutputMotionVectorIfNeeded(max(l9_153,vec4(0.0)));
