...
//sampler sampler maskMapSmpSC 0:17
...
//texture texture2D maskMap 0:1:0:17
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_maskMap 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_maskMap 78 -1
//spec_const int intensityTextureLayout 79 0
//spec_const int maskMapLayout 80 0
...
vec3 l9_1=mix(vec3(pokeColor.xyz),vec3(pinchColor.xyz),vec3(pokePinchBlend));
int l9_2;
...
#endif
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_maskMap)!=0));
float l9_4=varTex01.z;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x);
float l9_5=l9_4;
float l9_6=varTex01.w;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,maskMapUvMinMax.x,maskMapUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_maskMap)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,maskMapUvMinMax.y,maskMapUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_maskMap)!=0),maskMapTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskMap,SC_SOFTWARE_WRAP_MODE_V_maskMap).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),maskMapLayout,l9_2);
vec4 l9_25=texture2D(maskMap,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_maskMap)
{
l9_26=mix(maskMapBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#endif
float l9_27=1.0-dot(normalize(varNormalAndMotion.xyz),normalize(sc_Camera.position-varPosAndMotion.xyz));
bool l9_28=l9_27<=0.0;
float l9_29;
if (l9_28)
{
l9_29=0.0;
...
{
l9_29=pow(l9_27,pinchExponent);
}
float l9_30=l9_26.x*l9_29;
float l9_31;
if (l9_28)
{
l9_31=0.0;
...
{
l9_31=pow(l9_27,pokeExponent);
}
float l9_32=l9_31*l9_26.y;
float l9_33=radians(Port_Rotation_N018);
float l9_34=clamp((vec2(dot(vec2(cos(l9_33),sin(l9_33)),varTex01.xy-Port_Center_N018),0.0)+Port_Center_N018).x,0.0,1.0);
float l9_35;
if (l9_34<Port_Position1_N020)
{
l9_35=mix(Port_Value0_N020,Port_Value1_N020,clamp(l9_34/Port_Position1_N020,0.0,1.0));
}
else
{
float l9_36;
if (l9_34<pokeHighlightGradientMaskPosition)
{
l9_36=mix(Port_Value1_N020,Port_Value2_N020,clamp((l9_34-Port_Position1_N020)/(pokeHighlightGradientMaskPosition-Port_Position1_N020),0.0,1.0));
}
else
{
l9_36=mix(Port_Value2_N020,Port_Value3_N020,clamp((l9_34-pokeHighlightGradientMaskPosition)/(1.0-pokeHighlightGradientMaskPosition),0.0,1.0));
}
l9_35=l9_36;
}
...
bool l9_39;
vec4 l9_40;
if (l9_38&&(20==PreviewNodeID))
{
vec4 l9_41=vec4(l9_35,l9_35,l9_35,1.0);
l9_41.w=1.0;
l9_40=l9_41;
l9_39=true;
}
...
float l9_42=(pokeBrightness*l9_32)*l9_35;
float l9_43=max(pinchBrightness*l9_30,l9_42);
vec4 l9_44=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_44.w=l9_43;
...
{
l9_48=clamp(dot(l9_44.xyz,vec3(l9_43)),0.0,1.0);
}
#else
{
float l9_49;
...
{
l9_50=(1.0-dot(l9_44.xyz,vec3(0.33333001)))*l9_43;
}
#else
{
float l9_51;
...
{
l9_51=(1.0-clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0))*l9_43;
}
#else
{
float l9_52;
...
{
l9_52=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*l9_43;
}
#else
{
float l9_53;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_54=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*l9_43;
}
#else
{
float l9_55;
...
{
l9_55=dot(l9_44.xyz,vec3(0.33333001))*l9_43;
}
#else
{
float l9_56;
...
#endif
vec3 l9_63=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_44.xyz).xyz,vec3(l9_43));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_68=vec4(mix(vec3(1.0),l9_44.xyz,vec3(l9_43)),l9_43);
}
#else
{
vec4 l9_69;
...
vec4 l9_73=sc_OutputMotionVectorIfNeeded(max(l9_71,vec4(0.0)));
