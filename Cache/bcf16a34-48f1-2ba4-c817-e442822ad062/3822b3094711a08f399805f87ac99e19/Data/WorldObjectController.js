...
function onUpdateEvent(eventData) {
    print("WorldObjectController2 onUpdateEvent called - frame " + debugCounter);
    ...
    if (debugCounter % 60 === 0) {
        if (buttonState) {
            print("WorldObjectController2: ButtonState exists, LT value: " + (buttonState.lt || "undefined"));
        } else {
            print("WorldObjectController2: ButtonState is null/undefined");
        }
    }
    ...
    if (buttonState) {
        ...
        if (ltValue > 0.1) {
            print("WorldObjectController2: LT detected with value: " + ltValue + ", threshold met: " + isLTPressed);
        }
