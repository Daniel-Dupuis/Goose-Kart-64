...
function onUpdateEvent(eventData) {
    ...
    if (buttonState) {
        // Debug: Log all available properties to see what's actually available
        if (Math.random() < 0.01) { // Log occasionally to avoid spam
            print("ButtonState properties: " + Object.keys(buttonState).join(", "));
            print("LT value: " + (buttonState.lt || "undefined"));
            print("Left trigger alternatives: " + (buttonState.leftTrigger || "undefined") + ", " + (buttonState.l2 || "undefined"));
        }
        
        // Try different possible property names for left trigger
        var ltValue = buttonState.lt || buttonState.leftTrigger || buttonState.l2 || 0.0;
        ...
        // Debug: Check if buttonState is null
        if (Math.random() < 0.01) {
            print("ButtonState is null or undefined");
        }
    }
