...
{
vec2 l9_9;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_9,l9_2);
float l9_10;
Node67_Bool_Parameter(l9_10,l9_2);
l9_8=mix(varTex01.xy,l9_9,vec2(l9_10));
}
#else
{
vec2 l9_11;
...
{
vec2 l9_13;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_13,l9_2);
l9_12=((l9_13*Tweak_N50)+Tweak_N51)+(Tweak_N51*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_14;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_14,l9_2);
l9_12=(l9_14*Tweak_N50)+Tweak_N51;
}
#endif
float l9_15;
#if (Tweak_N25)
...
#endif
l9_11=mix(varTex01.xy,l9_12,vec2(l9_15-0.001));
}
#else
{
l9_11=varTex01.xy;
...
float l9_37=l9_36;
vec3 l9_38=sc_SamplingCoordsViewToGlobal(vec2(l9_33,l9_35),opacityTexLayout,l9_16);
vec4 l9_39=texture2D(opacityTex,l9_38.xy,0.0);
vec4 l9_40;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#endif
l9_3=mix(Port_Input0_N006,l9_5,vec3(l9_40.x));
}
#else
{
vec3 l9_41;
Node0_Shadow_Sample(l9_41,l9_2);
l9_3=l9_41;
}
#endif
vec4 l9_42=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_42.w=Port_Value2_N001;
...
{
l9_45=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_46=clamp(dot(l9_42.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_48=(1.0-dot(l9_42.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_49;
...
{
l9_49=(1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_50;
...
{
l9_50=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_51;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_52=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_53;
...
{
l9_53=dot(l9_42.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_54;
...
#endif
vec3 l9_61=mix(l9_58.xyz,definedBlend(l9_58.xyz,l9_42.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_66=vec4(mix(vec3(1.0),l9_42.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_67;
...
{
l9_68=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_68=Port_Value2_N001;
}
#endif
...
vec4 l9_71=sc_OutputMotionVectorIfNeeded(max(l9_69,vec4(0.0)));
