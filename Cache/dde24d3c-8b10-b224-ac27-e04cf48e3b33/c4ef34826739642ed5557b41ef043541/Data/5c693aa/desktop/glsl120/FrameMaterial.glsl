...
float l9_70=l9_69;
vec3 l9_71=sc_SamplingCoordsViewToGlobal(vec2(l9_66,l9_68),matcapTextureLayout,l9_49);
vec4 l9_72=texture2D(matcapTexture,l9_71.xy,0.0);
vec4 l9_73;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
...
{
l9_74=pow(l9_44,Port_Input1_N087);
}
vec4 l9_75=vec4(l9_74);
vec4 l9_76=max(l9_45,mix(Port_Input0_N024,Port_Input1_N024,l9_75));
float l9_77=borderAlpha*l9_44;
float l9_78;
if (l9_32<=0.0)
{
l9_78=0.0;
...
{
l9_78=pow(l9_32,(((borderAlpha-Port_RangeMinA_N129)/((Port_RangeMaxA_N129-Port_RangeMinA_N129)+1e-06))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_79=(backingAlpha*Port_Input1_N052)*l9_78;
float l9_80=(isHovered*smoothstep(Port_Input0_N166*l9_2,Port_Input1_N165,l9_16))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_33),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_33),0.0,1.0))*((((0.0+((l9_36*l9_39)*scaleHandles.x))+((l9_41*l9_39)*scaleHandles.y))+((l9_41*l9_43)*scaleHandles.z))+((l9_36*l9_43)*scaleHandles.w)));
vec4 l9_81=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_81.w=l9_80;
vec4 l9_82=mix(vec4((Port_Value_N151.xyz*l9_79)+((l9_76*vec4(Port_Input1_N149)).xyz*l9_77),max(l9_79,l9_77)),l9_81,vec4(l9_80));
vec3 l9_83=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_21),vec3(l9_25))+l9_82.xyz;
float l9_84=max((l9_82.w*opacity)*max(Port_Input0_N107-cutOutCenter,smoothstep(Port_Input0_N106,Port_Input0_N091/l9_1,length(max(abs(l9_12)-vec2(Port_Input1_N085),Port_Input1_N102)/l9_15))),l9_25*((Port_Value_N116+0.001)-0.001));
vec4 l9_85=vec4(l9_83.x,l9_83.y,l9_83.z,vec4(0.0).w);
l9_85.w=l9_84;
if ((step(l9_84,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_84<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_84<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_89=clamp(dot(l9_85.xyz,vec3(l9_84)),0.0,1.0);
}
#else
{
float l9_90;
...
{
l9_91=(1.0-dot(l9_85.xyz,vec3(0.33333001)))*l9_84;
}
#else
{
float l9_92;
...
{
l9_92=(1.0-clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0))*l9_84;
}
#else
{
float l9_93;
...
{
l9_93=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0)*l9_84;
}
#else
{
float l9_94;
#if (sc_BlendMode_Add)
{
l9_94=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_95;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_95=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0)*l9_84;
}
#else
{
float l9_96;
...
{
l9_96=dot(l9_85.xyz,vec3(0.33333001))*l9_84;
}
#else
{
float l9_97;
#if (sc_BlendMode_Min)
{
l9_97=1.0-clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_98;
#if (sc_BlendMode_Max)
{
l9_98=clamp(dot(l9_85.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_98=1.0;
...
#endif
l9_86=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_85.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_87);
}
#else
{
vec4 l9_99;
...
#if (sc_FramebufferFetch)
{
l9_101=sc_readFragData0_Platform();
}
#else
{
...
{
l9_103=1-sc_GetStereoViewIndex();
}
#else
{
l9_103=sc_GetStereoViewIndex();
}
#endif
l9_101=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_102,sc_ScreenTextureLayout,l9_103).xy,0.0);
}
#endif
vec3 l9_104=mix(l9_101.xyz,definedBlend(l9_101.xyz,l9_85.xyz).xyz,vec3(l9_84));
vec4 l9_105=vec4(l9_104.x,l9_104.y,l9_104.z,vec4(0.0).w);
l9_105.w=1.0;
l9_100=l9_105;
}
#else
...
#if (sc_Voxelization)
{
l9_106=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_107;
#if (sc_OutputBounds)
{
float l9_108=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_107=vec4(l9_108,1.0-l9_108,1.0,1.0);
}
#else
{
vec4 l9_109;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_109=vec4(mix(vec3(1.0),l9_85.xyz,vec3(l9_84)),l9_84);
}
#else
{
vec4 l9_110;
...
#endif
l9_110=vec4(l9_85.xyz*l9_111,l9_111);
}
#else
{
l9_110=l9_85;
...
vec4 l9_114=sc_OutputMotionVectorIfNeeded(max(l9_112,vec4(0.0)));
