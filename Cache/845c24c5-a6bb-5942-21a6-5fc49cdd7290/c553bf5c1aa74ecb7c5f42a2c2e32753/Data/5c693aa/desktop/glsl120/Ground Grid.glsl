...
#endif
vec2 l9_0=(vec2(varPosAndMotion.xz)*Port_Input1_N015)*vec2(uvScale);
int l9_1;
...
#endif
vec3 l9_26=l9_25.xyz*baseColor;
vec2 l9_27=((((varTex01.xy-Port_Center_N085)*(vec2(Port_Input0_N020)/clamp(Port_Import_N091,vec2(0.0),vec2(10.0))))+Port_Center_N085)*vec2(Port_Input1_N021))-vec2(Port_Input1_N022);
float l9_28=atan(l9_27.y*Port_Input1_N024,l9_27.x);
float l9_29=(Port_Input0_N027*3.1415927)/clamp(floor(Port_Import_N028),Port_Input1_N030,Port_Input2_N030);
float l9_30=((((1.0-(cos((floor((l9_28/l9_29)+Port_Input1_N033)*l9_29)-l9_28)*length(l9_27)))-Port_RangeMinA_N039)/((clamp(Port_Import_N025,0.0,1.0)-Port_RangeMinA_N039)+1e-06))*(Port_RangeMaxB_N039-Port_RangeMinB_N039))+Port_RangeMinB_N039;
vec4 l9_31=vec4(l9_26.x,l9_26.y,l9_26.z,vec4(0.0).w);
l9_31.w=l9_30;
...
vec4 l9_60=sc_OutputMotionVectorIfNeeded(max(l9_58,vec4(0.0)));
