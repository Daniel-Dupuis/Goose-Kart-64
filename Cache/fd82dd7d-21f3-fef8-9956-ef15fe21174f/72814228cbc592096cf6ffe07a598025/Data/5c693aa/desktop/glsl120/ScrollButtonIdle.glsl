...
float l9_60=clamp(length((varTex01.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_61;
if (l9_60<Port_Position1_N031)
{
l9_61=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_60/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_62;
if (l9_60<Port_Position2_N031)
{
l9_62=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_60-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_63;
if (l9_60<Port_Position3_N031)
{
l9_63=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_60-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_63=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_60-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_62=l9_63;
}
l9_61=l9_62;
}
vec3 l9_64=l9_2*Port_Import_N041;
float l9_65=dot(l9_64,l9_64);
float l9_66;
if (l9_65>0.0)
{
l9_66=1.0/sqrt(l9_65);
}
else
{
l9_66=0.0;
}
vec3 l9_67=l9_64*l9_66;
vec3 l9_68=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_67,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
int l9_69;
...
#endif
bool l9_70=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0));
float l9_71=l9_68.x;
sc_SoftwareWrapEarly(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_72=l9_71;
float l9_73=l9_68.y;
sc_SoftwareWrapEarly(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_74=l9_73;
vec2 l9_75;
float l9_76;
...
{
l9_77=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
l9_77=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_78=l9_72;
float l9_79=1.0;
sc_ClampUV(l9_78,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_77,l9_79);
float l9_80=l9_78;
float l9_81=l9_79;
bool l9_82;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_82=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_82=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_83=l9_74;
float l9_84=l9_81;
sc_ClampUV(l9_83,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_82,l9_84);
l9_76=l9_84;
...
#endif
vec2 l9_85=sc_TransformUV(l9_75,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_86=l9_85.x;
float l9_87=l9_76;
sc_SoftwareWrapLate(l9_86,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,l9_70,l9_87);
float l9_88=l9_85.y;
float l9_89=l9_87;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,l9_70,l9_89);
float l9_90=l9_89;
vec3 l9_91=sc_SamplingCoordsViewToGlobal(vec2(l9_86,l9_88),capsule_btn_refl_tex_1Layout,l9_69);
vec4 l9_92=texture2D(capsule_btn_refl_tex_1,l9_91.xy,0.0);
vec4 l9_93;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_93=mix(capsule_btn_refl_tex_1BorderColor,l9_92,vec4(l9_90));
}
#else
{
l9_93=l9_92;
...
#endif
vec4 l9_94=vec4(Port_Import_N027)*l9_93;
float l9_95=clamp(((l9_94.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_96;
if (l9_95<Port_Position1_N005)
{
l9_96=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_95/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_97;
if (l9_95<Port_Position2_N005)
{
l9_97=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_95-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_97=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_95-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_96=l9_97;
}
vec4 l9_98=mix(l9_96,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),l9_2*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec4 l9_99=l9_61+l9_98;
float l9_100;
if (l9_60<Port_Position1_N016)
{
l9_100=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_60/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_101;
if (l9_60<Port_Position2_N016)
{
l9_101=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_60-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_102;
if (l9_60<Port_Position3_N016)
{
l9_102=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_60-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_102=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_60-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_101=l9_102;
}
l9_100=l9_101;
}
vec4 l9_103=vec4(l9_99.x,l9_99.y,l9_99.z,vec4(0.0).w);
l9_103.w=l9_100;
vec4 l9_104=l9_59+l9_103;
...
{
l9_108=clamp(l9_105*2.0,0.0,1.0);
}
#else
{
float l9_109;
...
{
l9_109=clamp(dot(l9_104.xyz,vec3(l9_105)),0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_111=(1.0-dot(l9_104.xyz,vec3(0.33333001)))*l9_105;
}
#else
{
float l9_112;
...
{
l9_112=(1.0-clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0))*l9_105;
}
#else
{
float l9_113;
...
{
l9_113=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0)*l9_105;
}
#else
{
float l9_114;
#if (sc_BlendMode_Add)
{
l9_114=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_115;
...
{
l9_116=dot(l9_104.xyz,vec3(0.33333001))*l9_105;
}
#else
{
float l9_117;
#if (sc_BlendMode_Min)
{
l9_117=1.0-clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_118;
#if (sc_BlendMode_Max)
{
l9_118=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_118=1.0;
...
#endif
l9_106=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_104.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_107);
}
#else
{
vec4 l9_119;
...
#endif
l9_121=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_122,sc_ScreenTextureLayout,l9_123).xy,0.0);
}
#endif
vec3 l9_124=mix(l9_121.xyz,definedBlend(l9_121.xyz,l9_104.xyz).xyz,vec3(l9_105));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_129=vec4(mix(vec3(1.0),l9_104.xyz,vec3(l9_105)),l9_105);
}
#else
{
vec4 l9_130;
...
#endif
l9_130=vec4(l9_104.xyz*l9_131,l9_131);
}
#else
{
l9_130=l9_104;
...
vec4 l9_134=sc_OutputMotionVectorIfNeeded(max(l9_132,vec4(0.0)));
...
#endif
int l9_138=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_137).xy);
...
if (l9_155==0)
{
l9_158=texture2D(sc_OITAlpha0,l9_150);
l9_157=texture2D(sc_OITDepthLow0,l9_150);
l9_156=texture2D(sc_OITDepthHigh0,l9_150);
}
else
{
l9_158=vec4(0.0);
...
if (l9_155==1)
{
l9_161=texture2D(sc_OITAlpha1,l9_150);
l9_160=texture2D(sc_OITDepthLow1,l9_150);
l9_159=texture2D(sc_OITDepthHigh1,l9_150);
}
else
{
l9_161=l9_158;
...
vec4 l9_176=texture2D(sc_OITFilteredDepthBoundsTexture,l9_150);
