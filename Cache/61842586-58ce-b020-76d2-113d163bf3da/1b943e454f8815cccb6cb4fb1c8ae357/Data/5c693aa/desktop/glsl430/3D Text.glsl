...
sc_RayTracingNormalAndMore.w=uint(clamp(Port_Roughness_N003,0.0,1.0)*1000.0)|((sc_RayTracingReceiverId%32u)<<10u);
}
...
#endif
vec3 l9_7=max(frontColor.xyz,vec3(0.0));
vec4 l9_8;
#if (sc_ProjectiveShadowsCaster)
{
l9_8=vec4(l9_7,Port_Opacity_N003);
}
#else
{
l9_8=ngsCalculateLighting(l9_7,Port_Opacity_N003,l9_6,l9_3,l9_4,Port_Emissive_N003,Port_Metallic_N003,Port_Roughness_N003,Port_AO_N003,Port_SpecularAO_N003);
}
#endif
vec4 l9_9=max(l9_8,vec4(0.0));
vec4 l9_10=mix(l9_9,sideColor,vec4(step(l9_1.y,Port_Input1_N014)));
if (l9_0)
{
vec4 l9_11;
...
#endif
sc_writeFragData0Internal(max(l9_11,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_13;
#if (sc_ProjectiveShadowsCaster)
...
{
float l9_35=l9_10.w;
l9_34=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_35)),l9_35);
}
#else
{
vec4 l9_36;
...
#endif
l9_36=vec4(l9_10.xyz*l9_38,l9_38);
}
#else
{
l9_36=l9_10;
