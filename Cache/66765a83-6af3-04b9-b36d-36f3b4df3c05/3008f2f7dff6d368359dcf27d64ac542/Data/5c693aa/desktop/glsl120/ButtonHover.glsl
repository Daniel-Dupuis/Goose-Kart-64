...
l9_73.w=l9_70;
vec2 l9_74=((varTex01.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
...
vec4 l9_126=mix(mix(l9_32,l9_60,vec4(Port_Input2_N005))+mix(l9_73,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031)),l9_100,l9_125);
...
#endif
l9_143=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_144,sc_ScreenTextureLayout,l9_145).xy,0.0);
}
#endif
vec3 l9_146=mix(l9_143.xyz,definedBlend(l9_143.xyz,l9_126.xyz).xyz,vec3(l9_127));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_151=vec4(mix(vec3(1.0),l9_126.xyz,vec3(l9_127)),l9_127);
}
#else
{
vec4 l9_152;
...
#endif
l9_152=vec4(l9_126.xyz*l9_153,l9_153);
}
#else
{
l9_152=l9_126;
