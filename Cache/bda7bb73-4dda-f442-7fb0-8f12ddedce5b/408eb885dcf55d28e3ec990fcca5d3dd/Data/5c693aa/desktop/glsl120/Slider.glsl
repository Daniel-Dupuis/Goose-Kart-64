...
//spec_const bool sc_VertexBlendingUseNormals 100 0
//spec_const bool sc_Voxelization 101 0
//spec_const int NODE_13_DROPLIST_ITEM 102 0
//spec_const int NODE_181_DROPLIST_ITEM 103 0
//spec_const int NODE_184_DROPLIST_ITEM 104 0
//spec_const int NODE_27_DROPLIST_ITEM 105 0
//spec_const int NODE_38_DROPLIST_ITEM 106 0
//spec_const int NODE_49_DROPLIST_ITEM 107 0
//spec_const int NODE_69_DROPLIST_ITEM 108 0
//spec_const int SC_DEVICE_CLASS 109 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 110 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 111 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 112 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 113 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 114 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 115 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 116 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 117 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 118 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 119 -1
//spec_const int baseTexLayout 120 0
//spec_const int detailNormalTexLayout 121 0
//spec_const int intensityTextureLayout 122 0
//spec_const int normalTexLayout 123 0
//spec_const int opacityTexLayout 124 0
//spec_const int sc_AmbientLightMode0 125 0
//spec_const int sc_AmbientLightMode1 126 0
//spec_const int sc_AmbientLightMode2 127 0
//spec_const int sc_AmbientLightMode_Constant 128 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 129 0
//spec_const int sc_AmbientLightMode_FromCamera 130 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 131 0
//spec_const int sc_AmbientLightsCount 132 0
//spec_const int sc_DepthBufferMode 133 0
//spec_const int sc_DirectionalLightsCount 134 0
//spec_const int sc_EnvLightMode 135 0
//spec_const int sc_EnvmapDiffuseLayout 136 0
//spec_const int sc_EnvmapSpecularLayout 137 0
//spec_const int sc_LightEstimationSGCount 138 0
...
ssGlobals l9_6=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_0,varPosAndMotion.xyz,varColor,varTex01.xy,varTex01.zw,l9_2,l9_3,l9_4,l9_5);
vec4 l9_7;
...
#if (sc_SSAOEnabled)
{
l9_126=evaluateSSAO(varPosAndMotion.xyz);
}
#else
{
l9_126=Port_AO_N036;
...
SurfaceProperties l9_128=SurfaceProperties(l9_127,l9_120,l9_124,varPosAndMotion.xyz,l9_0,0.0,1.0,l9_125,l9_126,vec3(1.0),vec3(1.0),vec3(0.039999999));
...
{
vec3 l9_168=sc_PointLights[l9_166].position-varPosAndMotion.xyz;
...
#endif
l9_185=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_186,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#else
{
vec4 l9_187;
...
#else
{
l9_187=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_184,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#endif
l9_185=l9_187;
}
...
float l9_239;
if ((float(varTex01.x<Level)*1.0)!=0.0)
{
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_264=vec4(mix(vec3(1.0),l9_242.xyz,vec3(l9_241)),l9_241);
}
#else
{
vec4 l9_265;
...
#endif
l9_265=vec4(l9_242.xyz*l9_266,l9_266);
}
#else
{
l9_265=l9_242;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_272=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_272).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_273=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_272).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_285=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_285).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_290==0)
{
l9_293=texture2D(sc_OITAlpha0,l9_285);
l9_292=texture2D(sc_OITDepthLow0,l9_285);
l9_291=texture2D(sc_OITDepthHigh0,l9_285);
}
else
{
l9_293=vec4(0.0);
...
if (l9_290==1)
{
l9_296=texture2D(sc_OITAlpha1,l9_285);
l9_295=texture2D(sc_OITDepthLow1,l9_285);
l9_294=texture2D(sc_OITDepthHigh1,l9_285);
}
else
{
l9_296=l9_293;
...
vec4 l9_311=texture2D(sc_OITFilteredDepthBoundsTexture,l9_285);
