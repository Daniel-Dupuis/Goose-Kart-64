...
#if (sc_FramebufferFetch)
{
l9_174=sc_readFragData0_Platform();
}
#else
{
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_189-0.0039215689)),min(1.0,l9_189+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_191),packValue(l9_191),packValue(l9_191),packValue(l9_191)),sc_UniformConstants.x,sc_ShaderCacheConstant);
