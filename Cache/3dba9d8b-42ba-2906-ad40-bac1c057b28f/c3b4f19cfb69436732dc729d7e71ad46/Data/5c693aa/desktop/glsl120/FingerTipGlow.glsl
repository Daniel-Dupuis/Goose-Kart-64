...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glowTexture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glowTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int glowTextureLayout 79 0
...
#endif
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glowTexture)!=0));
float l9_2=varTex01.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x);
float l9_3=l9_2;
float l9_4=varTex01.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,glowTextureUvMinMax.x,glowTextureUvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_glowTexture)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_glowTexture)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,glowTextureUvMinMax.y,glowTextureUvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_glowTexture)!=0),glowTextureTransform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_glowTexture,SC_SOFTWARE_WRAP_MODE_V_glowTexture).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),glowTextureLayout,l9_0);
vec4 l9_23=texture2D(glowTexture,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_glowTexture)
{
l9_24=mix(glowTextureBorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
#endif
vec4 l9_25=mix(pokeGlowColor,pinchGlowColor,vec4(pokePinchBlend));
vec3 l9_26=vec3(l9_24.xyz)*vec3(l9_25.xyz);
float l9_27=(l9_25.w*l9_24.w)*mix(pokeGlowBrightness,pinchGlowBrightness,pokePinchBlend);
...
#if (sc_FramebufferFetch)
{
l9_44=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_44=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_45,sc_ScreenTextureLayout,l9_46).xy,0.0);
}
#endif
vec3 l9_47=mix(l9_44.xyz,definedBlend(l9_44.xyz,l9_28.xyz).xyz,vec3(l9_27));
...
#if (sc_Voxelization)
{
l9_49=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_50;
#if (sc_OutputBounds)
{
float l9_51=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_50=vec4(l9_51,1.0-l9_51,1.0,1.0);
}
#else
{
vec4 l9_52;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_52=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_27)),l9_27);
}
#else
{
vec4 l9_53;
...
#endif
l9_53=vec4(l9_28.xyz*l9_54,l9_54);
}
#else
{
l9_53=l9_28;
...
vec4 l9_57=sc_OutputMotionVectorIfNeeded(max(l9_55,vec4(0.0)));
