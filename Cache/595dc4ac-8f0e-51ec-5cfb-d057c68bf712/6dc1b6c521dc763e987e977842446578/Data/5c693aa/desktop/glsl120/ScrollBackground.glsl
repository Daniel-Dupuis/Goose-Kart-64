...
#endif
l9_31=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_32,sc_ScreenTextureLayout,l9_33).xy,0.0);
}
#endif
vec3 l9_34=mix(l9_31.xyz,definedBlend(l9_31.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_39=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_40;
...
#endif
l9_40=vec4(l9_1.xyz*l9_41,l9_41);
}
#else
{
l9_40=l9_1;
