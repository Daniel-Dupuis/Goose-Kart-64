...
float l9_1=clamp((varTex01.xy+Port_Offset_N009).x,0.0,1.0);
vec4 l9_2;
...
vec4 l9_15=l9_10*vec4(smoothstep(Port_Input0_N005+level,level,varTex01.x));
float l9_16=l9_15.w;
...
#endif
l9_32=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_33,sc_ScreenTextureLayout,l9_34).xy,0.0);
}
#endif
vec3 l9_35=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_15.xyz).xyz,vec3(l9_16));
vec4 l9_36=vec4(l9_35.x,l9_35.y,l9_35.z,vec4(0.0).w);
l9_36.w=1.0;
l9_31=l9_36;
}
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_40=vec4(mix(vec3(1.0),l9_15.xyz,vec3(l9_16)),l9_16);
}
#else
{
vec4 l9_41;
...
#endif
l9_41=vec4(l9_15.xyz*l9_42,l9_42);
}
#else
{
l9_41=l9_15;
