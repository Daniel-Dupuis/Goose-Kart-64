...
ssGlobals l9_2=ssGlobals(sc_Time.x,sc_Time.y,0.0,varTex01.xy,varTex01.zw,l9_1);
vec4 l9_3;
#if (ENABLE_BASE_TEX)
{
vec2 l9_4;
...
l9_6=mix(varTex01.xy,l9_7,vec2(l9_8));
}
#else
{
vec2 l9_9;
...
l9_9=mix(varTex01.xy,l9_10,vec2(l9_11));
}
#else
{
l9_9=varTex01.xy;
...
l9_41=mix(varTex01.xy,l9_42,vec2(l9_43));
}
#else
{
vec2 l9_44;
...
l9_44=mix(varTex01.xy,l9_45,vec2(l9_46));
}
#else
{
l9_44=varTex01.xy;
...
float l9_73=l9_72*max(smoothstep(blur,blur*Port_Input1_N098,length(max(abs(varTex01.xy-Port_Input1_N085)-(boxSize-vec2(cornerRadius)),Port_Input1_N089))-cornerRadius),Port_Input1_N094);
vec4 l9_74=vec4(l9_37.x,l9_37.y,l9_37.z,vec4(0.0).w);
l9_74.w=l9_73;
vec3 l9_75=smoothstep(Port_Input0_N073,Port_Input1_N073,vec3(distance(Port_Input0_N042,(varTex01.xy-Port_Input1_N046)*vec2(Port_Input1_N047))));
float l9_76=sin(sc_Time.x*Port_Multiplier_N054);
float l9_77=(max(((l9_76*Port_Input1_N078)*l9_76)*Port_Input1_N080,Port_Input1_N079)*Port_Input1_N057)+Port_Input1_N070;
float l9_78=l9_75.x;
float l9_79;
if (l9_78<=0.0)
{
...
{
l9_83=pow(l9_82,l9_77);
}
vec3 l9_84=mix(vec3(l9_79,l9_81,l9_83),vec3(floor(fract(sin(floor(dot(floor((floor(varTex01.xy*10000.0)*9.9999997e-05)*Port_Scale_N081),vec2(0.98000002,0.72000003))*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05),vec3(Port_Input2_N082));
vec4 l9_85=vec4(l9_84.x,l9_84.y,l9_84.z,vec4(0.0).w);
l9_85.w=l9_73;
vec4 l9_86=mix(l9_74,l9_85,vec4(Port_Input2_N045));
if ((step(l9_73,Port_Input1_N099)*1.0)!=0.0)
{
discard;
}
float l9_87=l9_86.w;
...
{
if (l9_87<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_91=clamp(dot(l9_86.xyz,vec3(l9_87)),0.0,1.0);
}
#else
{
float l9_92;
...
{
l9_93=(1.0-dot(l9_86.xyz,vec3(0.33333001)))*l9_87;
}
#else
{
float l9_94;
...
{
l9_94=(1.0-clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0))*l9_87;
}
#else
{
float l9_95;
...
{
l9_95=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0)*l9_87;
}
#else
{
float l9_96;
#if (sc_BlendMode_Add)
{
l9_96=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_97;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_97=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0)*l9_87;
}
#else
{
float l9_98;
...
{
l9_98=dot(l9_86.xyz,vec3(0.33333001))*l9_87;
}
#else
{
float l9_99;
#if (sc_BlendMode_Min)
{
l9_99=1.0-clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_100;
#if (sc_BlendMode_Max)
{
l9_100=clamp(dot(l9_86.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_100=1.0;
...
#endif
l9_88=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_86.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_89);
}
#else
{
vec4 l9_101;
...
#if (sc_FramebufferFetch)
{
l9_103=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_103=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_104,sc_ScreenTextureLayout,l9_105).xy,0.0);
}
#endif
vec3 l9_106=mix(l9_103.xyz,definedBlend(l9_103.xyz,l9_86.xyz).xyz,vec3(l9_87));
...
#if (sc_Voxelization)
{
l9_108=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_109;
#if (sc_OutputBounds)
{
float l9_110=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_109=vec4(l9_110,1.0-l9_110,1.0,1.0);
}
#else
{
vec4 l9_111;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_111=vec4(mix(vec3(1.0),l9_86.xyz,vec3(l9_87)),l9_87);
}
#else
{
vec4 l9_112;
...
#endif
l9_112=vec4(l9_86.xyz*l9_113,l9_113);
}
#else
{
l9_112=l9_86;
...
vec4 l9_116=sc_OutputMotionVectorIfNeeded(max(l9_114,vec4(0.0)));
vec4 l9_117=clamp(l9_116,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_118=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_118-0.0039215689)),min(1.0,l9_118+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_120=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_119).xy);
float l9_121=packValue(l9_120);
int l9_128=int(l9_117.w*255.0);
float l9_129=packValue(l9_128);
sc_writeFragData0Internal(vec4(packValue(l9_120),packValue(l9_120),packValue(l9_120),packValue(l9_120)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_121,packValue(l9_120),packValue(l9_120),packValue(l9_120)));
sc_writeFragData2(vec4(l9_129,packValue(l9_128),packValue(l9_128),packValue(l9_128)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_132=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_132).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_137==0)
{
l9_140=texture2D(sc_OITAlpha0,l9_132);
l9_139=texture2D(sc_OITDepthLow0,l9_132);
l9_138=texture2D(sc_OITDepthHigh0,l9_132);
}
else
{
l9_140=vec4(0.0);
...
if (l9_137==1)
{
l9_143=texture2D(sc_OITAlpha1,l9_132);
l9_142=texture2D(sc_OITDepthLow1,l9_132);
l9_141=texture2D(sc_OITDepthHigh1,l9_132);
}
else
{
l9_143=l9_140;
...
if (any(notEqual(l9_141,vec4(0.0)))||any(notEqual(l9_142,vec4(0.0))))
{
int l9_144[8]=l9_133;
unpackValues(l9_141.w,l9_137,l9_144);
unpackValues(l9_141.z,l9_137,l9_144);
unpackValues(l9_141.y,l9_137,l9_144);
unpackValues(l9_141.x,l9_137,l9_144);
unpackValues(l9_142.w,l9_137,l9_144);
unpackValues(l9_142.z,l9_137,l9_144);
unpackValues(l9_142.y,l9_137,l9_144);
unpackValues(l9_142.x,l9_137,l9_144);
int l9_153[8]=l9_134;
unpackValues(l9_143.w,l9_137,l9_153);
unpackValues(l9_143.z,l9_137,l9_153);
unpackValues(l9_143.y,l9_137,l9_153);
unpackValues(l9_143.x,l9_137,l9_153);
}
l9_137++;
continue;
}
...
vec4 l9_158=texture2D(sc_OITFilteredDepthBoundsTexture,l9_132);
vec2 l9_159=l9_158.xy;
int l9_160;
#if (sc_SkinBonesCount>0)
{
l9_160=encodeDepth(((1.0-l9_158.x)*1000.0)+getDepthOrderingEpsilon(),l9_159);
}
#else
{
l9_160=0;
...
#endif
int l9_161=encodeDepth(viewSpaceDepth(),l9_159);
vec4 l9_162;
l9_162=l9_117*l9_117.w;
vec4 l9_163;
int l9_164=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_164<8)
{
int l9_165=l9_133[l9_164];
int l9_166=l9_161-l9_160;
bool l9_167=l9_165<l9_166;
bool l9_168;
if (l9_167)
{
l9_168=l9_133[l9_164]>0;
}
else
{
l9_168=l9_167;
...
if (l9_168)
{
vec3 l9_169=l9_162.xyz*(1.0-(float(l9_134[l9_164])/255.0));
l9_163=vec4(l9_169.x,l9_169.y,l9_169.z,l9_162.w);
}
else
{
l9_163=l9_162;
