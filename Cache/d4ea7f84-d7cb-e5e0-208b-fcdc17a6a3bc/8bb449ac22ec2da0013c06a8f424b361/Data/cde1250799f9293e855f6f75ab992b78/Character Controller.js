...
let CharacterController = (() => {
    ...
    var CharacterController = _classThis = class extends _classSuper {
        __initialize() {
            super.__initialize();
            ...
            this.minMoveDistance = this.minMoveDistance;
            this.slopeLimit = this.slopeLimit;
            this.autoFaceMovementDirection = this.autoFaceMovementDirection;
            this.rotationSmoothing = this.rotationSmoothing;
            this.lockXAxis = this.lockXAxis;
            this.lockYAxis = this.lockYAxis;
            this.lockZAxis = this.lockZAxis;
            this.enableTouchBlocking = this.enableTouchBlocking;
            this.inputControlType = this.inputControlType;
            this.trackingCamera = this.trackingCamera;
            this.joystickConfig = this.joystickConfig;
            this.gravity = this.gravity;
            this.airControl = this.airControl;
            this.showCollider = this.showCollider;
            this.groundIsZero = this.groundIsZero;
            this.groundCheckDistance = this.groundCheckDistance;
            this.stepHeight = this.stepHeight;
            this.colliderHeight = this.colliderHeight;
            this.colliderRadius = this.colliderRadius;
            this.colliderCenter = this.colliderCenter;
            this.useAnimation = this.useAnimation;
            this.idleAnimationAsset = this.idleAnimationAsset;
            this.idlePlaybackSpeed = this.idlePlaybackSpeed;
            this.moveMinCharacterSpeed = this.moveMinCharacterSpeed;
            this.moveAnimationAsset = this.moveAnimationAsset;
            this.movePlaybackSpeed = this.movePlaybackSpeed;
            this.sprintMinCharacterSpeed = this.sprintMinCharacterSpeed;
            this.sprintAnimationAsset = this.sprintAnimationAsset;
            this.sprintPlaybackSpeed = this.sprintPlaybackSpeed;
    ...
    __setFunctionName(_classThis, "CharacterController");
    (() => {
        var _a;
