...
#endif
float l9_26=min(Port_objectWidth_N002,aspect)*0.1;
vec2 l9_27=abs(vec2(l9_0.x*Port_objectWidth_N002,l9_0.y*aspect))-((vec2(Port_objectWidth_N002,aspect)*0.5)-vec2(l9_26));
float l9_28=(length(max(l9_27,vec2(0.0)))+min(max(l9_27.x,l9_27.y),0.0))-l9_26;
vec4 l9_29;
if (l9_28>0.0)
{
discard;
...
{
if (l9_28>(-(Port_objectWidth_N002*outlineThickness)))
{
l9_29=outlineColor;
}
else
...
#endif
vec3 l9_48=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_29.xyz).xyz,vec3(l9_29.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_29.w)),l9_29.w);
}
#else
{
vec4 l9_54;
