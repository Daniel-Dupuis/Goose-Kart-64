...
#endif
float l9_53=min(Port_objectWidth_N002,aspect)*0.1;
vec2 l9_54=abs(vec2(l9_2.x*Port_objectWidth_N002,l9_2.y*aspect))-((vec2(Port_objectWidth_N002,aspect)*0.5)-vec2(l9_53));
float l9_55=(length(max(l9_54,vec2(0.0)))+min(max(l9_54.x,l9_54.y),0.0))-l9_53;
vec4 l9_56;
if (l9_55>0.0)
{
discard;
...
{
if (l9_55>(-(Port_objectWidth_N002*outlineThickness)))
{
l9_56=outlineColor;
}
else
...
{
if (l9_56.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_57,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_59;
...
#endif
vec3 l9_77=mix(l9_74.xyz,definedBlend(l9_74.xyz,l9_56.xyz).xyz,vec3(l9_56.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_82=vec4(mix(vec3(1.0),l9_56.xyz,vec3(l9_56.w)),l9_56.w);
}
#else
{
vec4 l9_83;
