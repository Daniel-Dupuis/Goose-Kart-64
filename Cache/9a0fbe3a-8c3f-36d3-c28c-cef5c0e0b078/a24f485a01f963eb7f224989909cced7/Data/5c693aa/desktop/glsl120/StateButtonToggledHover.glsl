...
float l9_61=clamp(length((varTex01.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_62;
...
vec4 l9_70=mix(l9_62,Port_Input1_N024,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
vec2 l9_71=((varTex01.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
...
#if (sc_FramebufferFetch)
{
l9_140=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_140=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_141,sc_ScreenTextureLayout,l9_142).xy,0.0);
}
#endif
vec3 l9_143=mix(l9_140.xyz,definedBlend(l9_140.xyz,l9_123.xyz).xyz,vec3(l9_124));
vec4 l9_144=vec4(l9_143.x,l9_143.y,l9_143.z,vec4(0.0).w);
l9_144.w=1.0;
l9_139=l9_144;
}
#else
...
#if (sc_Voxelization)
{
l9_145=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_146;
#if (sc_OutputBounds)
{
float l9_147=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_146=vec4(l9_147,1.0-l9_147,1.0,1.0);
}
#else
{
vec4 l9_148;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_148=vec4(mix(vec3(1.0),l9_123.xyz,vec3(l9_124)),l9_124);
}
#else
{
vec4 l9_149;
...
#endif
l9_149=vec4(l9_123.xyz*l9_150,l9_150);
}
#else
{
l9_149=l9_123;
...
vec4 l9_153=sc_OutputMotionVectorIfNeeded(max(l9_151,vec4(0.0)));
vec4 l9_154=clamp(l9_153,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_155=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_155-0.0039215689)),min(1.0,l9_155+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_156).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_157=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_156).xy);
float l9_158=packValue(l9_157);
int l9_165=int(l9_154.w*255.0);
float l9_166=packValue(l9_165);
sc_writeFragData0Internal(vec4(packValue(l9_157),packValue(l9_157),packValue(l9_157),packValue(l9_157)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_158,packValue(l9_157),packValue(l9_157),packValue(l9_157)));
sc_writeFragData2(vec4(l9_166,packValue(l9_165),packValue(l9_165),packValue(l9_165)));
...
if (l9_174==0)
{
l9_177=texture2D(sc_OITAlpha0,l9_169);
l9_176=texture2D(sc_OITDepthLow0,l9_169);
l9_175=texture2D(sc_OITDepthHigh0,l9_169);
}
else
{
l9_177=vec4(0.0);
...
if (l9_174==1)
{
l9_180=texture2D(sc_OITAlpha1,l9_169);
l9_179=texture2D(sc_OITDepthLow1,l9_169);
l9_178=texture2D(sc_OITDepthHigh1,l9_169);
}
else
{
l9_180=l9_177;
...
if (any(notEqual(l9_178,vec4(0.0)))||any(notEqual(l9_179,vec4(0.0))))
{
int l9_181[8]=l9_170;
unpackValues(l9_178.w,l9_174,l9_181);
unpackValues(l9_178.z,l9_174,l9_181);
unpackValues(l9_178.y,l9_174,l9_181);
unpackValues(l9_178.x,l9_174,l9_181);
unpackValues(l9_179.w,l9_174,l9_181);
unpackValues(l9_179.z,l9_174,l9_181);
unpackValues(l9_179.y,l9_174,l9_181);
unpackValues(l9_179.x,l9_174,l9_181);
int l9_190[8]=l9_171;
unpackValues(l9_180.w,l9_174,l9_190);
unpackValues(l9_180.z,l9_174,l9_190);
unpackValues(l9_180.y,l9_174,l9_190);
unpackValues(l9_180.x,l9_174,l9_190);
}
l9_174++;
continue;
}
...
vec4 l9_195=texture2D(sc_OITFilteredDepthBoundsTexture,l9_169);
vec2 l9_196=l9_195.xy;
int l9_197;
#if (sc_SkinBonesCount>0)
{
l9_197=encodeDepth(((1.0-l9_195.x)*1000.0)+getDepthOrderingEpsilon(),l9_196);
}
#else
{
l9_197=0;
...
#endif
int l9_198=encodeDepth(viewSpaceDepth(),l9_196);
vec4 l9_199;
l9_199=l9_154*l9_154.w;
vec4 l9_200;
int l9_201=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_201<8)
{
int l9_202=l9_170[l9_201];
int l9_203=l9_198-l9_197;
bool l9_204=l9_202<l9_203;
bool l9_205;
if (l9_204)
{
l9_205=l9_170[l9_201]>0;
}
else
{
l9_205=l9_204;
...
if (l9_205)
{
vec3 l9_206=l9_199.xyz*(1.0-(float(l9_171[l9_201])/255.0));
l9_200=vec4(l9_206.x,l9_206.y,l9_206.z,l9_199.w);
}
else
{
l9_200=l9_199;
...
sc_writeFragData0Internal(l9_199,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
