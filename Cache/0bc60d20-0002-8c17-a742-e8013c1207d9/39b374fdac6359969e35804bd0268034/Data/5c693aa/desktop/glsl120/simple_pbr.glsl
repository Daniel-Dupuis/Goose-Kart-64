...
#endif
vec4 l9_26=baseColor*l9_25;
vec3 l9_27;
#if (!sc_ProjectiveShadowsCaster)
{
l9_27=normalize(varNormalAndMotion.xyz);
}
#else
{
l9_27=vec3(0.0);
...
#endif
float l9_28=clamp(l9_26.w,0.0,1.0);
...
#endif
vec3 l9_29=max(l9_26.xyz,vec3(0.0));
vec4 l9_30;
#if (sc_ProjectiveShadowsCaster)
{
...
vec3 l9_35=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_36;
#if (sc_SSAOEnabled)
{
l9_36=evaluateSSAO(varPosAndMotion.xyz);
}
#else
{
l9_36=Port_AO_N006;
...
SurfaceProperties l9_40=SurfaceProperties(l9_39,l9_28,l9_34,varPosAndMotion.xyz,l9_0,l9_31,l9_32,l9_35,l9_36,Port_SpecularAO_N006,vec3(1.0),l9_38);
vec4 l9_41=vec4(1.0);
vec3 l9_42;
vec3 l9_43;
vec3 l9_44;
...
{
vec3 l9_80=sc_PointLights[l9_78].position-varPosAndMotion.xyz;
...
vec3 l9_153=l9_133*Port_SpecularAO_N006;
...
{
vec4 l9_161=l9_159;
l9_161.x=l9_158+((l9_36.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_160=l9_161;
}
#else
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_169=clamp(l9_166.w*2.0,0.0,1.0);
}
#else
{
float l9_170;
...
{
l9_170=clamp(dot(l9_166.xyz,vec3(l9_166.w)),0.0,1.0);
}
#else
{
float l9_171;
...
#if (sc_BlendMode_Multiply)
{
l9_172=(1.0-dot(l9_166.xyz,vec3(0.33333001)))*l9_166.w;
}
#else
{
float l9_173;
...
{
l9_173=(1.0-clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0))*l9_166.w;
}
#else
{
float l9_174;
#if (sc_BlendMode_ColoredGlass)
{
l9_174=clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0)*l9_166.w;
}
#else
{
float l9_175;
#if (sc_BlendMode_Add)
{
l9_175=clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_176;
...
{
l9_177=dot(l9_166.xyz,vec3(0.33333001))*l9_166.w;
}
#else
{
float l9_178;
#if (sc_BlendMode_Min)
{
l9_178=1.0-clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_179;
#if (sc_BlendMode_Max)
{
l9_179=clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_179=1.0;
...
#endif
l9_167=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_166.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_168);
}
#else
{
vec4 l9_180;
...
{
vec3 l9_182=sc_GetFramebufferColor().xyz;
vec3 l9_183=mix(l9_182,definedBlend(l9_182,l9_166.xyz).xyz,vec3(l9_166.w));
vec4 l9_184=vec4(l9_183.x,l9_183.y,l9_183.z,vec4(0.0).w);
l9_184.w=1.0;
l9_181=l9_184;
}
#else
...
#if (sc_Voxelization)
{
l9_185=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_186;
#if (sc_OutputBounds)
{
float l9_187=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_186=vec4(l9_187,1.0-l9_187,1.0,1.0);
}
#else
{
vec4 l9_188;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_189=l9_166.w;
l9_188=vec4(mix(vec3(1.0),l9_166.xyz,vec3(l9_189)),l9_189);
}
#else
{
vec4 l9_190;
...
#endif
l9_190=vec4(l9_166.xyz*l9_192,l9_192);
}
#else
{
l9_190=l9_166;
...
vec4 l9_195=sc_OutputMotionVectorIfNeeded(max(l9_193,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_198).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_199=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_198).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_211).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_216==0)
{
l9_219=texture2D(sc_OITAlpha0,l9_211);
l9_218=texture2D(sc_OITDepthLow0,l9_211);
l9_217=texture2D(sc_OITDepthHigh0,l9_211);
}
else
{
l9_219=vec4(0.0);
...
if (l9_216==1)
{
l9_222=texture2D(sc_OITAlpha1,l9_211);
l9_221=texture2D(sc_OITDepthLow1,l9_211);
l9_220=texture2D(sc_OITDepthHigh1,l9_211);
}
else
{
l9_222=l9_219;
...
vec4 l9_237=texture2D(sc_OITFilteredDepthBoundsTexture,l9_211);
