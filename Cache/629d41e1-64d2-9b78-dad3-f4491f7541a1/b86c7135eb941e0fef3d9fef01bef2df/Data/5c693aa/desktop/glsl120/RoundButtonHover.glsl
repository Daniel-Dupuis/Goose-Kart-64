...
{
vec4 l9_37;
if (l9_34<Port_Position3_N007)
{
l9_37=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_34-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_37=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_34-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_36=l9_37;
}
l9_35=l9_36;
}
vec4 l9_38=mix(l9_35,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPosAndMotion.xyz),l9_2*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_39=l9_38.w;
vec3 l9_40=(l9_33.xyz+Port_Input1_N002)+l9_38.xyz;
...
{
l9_45=clamp(dot(l9_41.xyz,vec3(l9_39)),0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_47=(1.0-dot(l9_41.xyz,vec3(0.33333001)))*l9_39;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0))*l9_39;
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*l9_39;
}
#else
{
float l9_50;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_51=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*l9_39;
}
#else
{
float l9_52;
...
{
l9_52=dot(l9_41.xyz,vec3(0.33333001))*l9_39;
}
#else
{
float l9_53;
...
#endif
l9_57=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_58,sc_ScreenTextureLayout,l9_59).xy,0.0);
}
#endif
vec3 l9_60=mix(l9_57.xyz,definedBlend(l9_57.xyz,l9_41.xyz).xyz,vec3(l9_39));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_65=vec4(mix(vec3(1.0),l9_41.xyz,vec3(l9_39)),l9_39);
}
#else
{
vec4 l9_66;
...
#endif
l9_66=vec4(l9_41.xyz*l9_67,l9_67);
}
#else
{
l9_66=l9_41;
